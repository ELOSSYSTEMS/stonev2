...
| UNIT-189 | Push repaired source to unpublished `Stonev2`. | PROPOSED | Existing theme id `156487712965` accepts the full theme root without rejected files or records exact remote blockers. | Shopify CLI operation against unpublished theme only. | Upload output; theme list; preview URL. |
| UNIT-190 | Repair Hebrew runtime locale filename. | PROPOSED | Runtime Hebrew locale is stored in a non-default locale file so Shopify has only one default runtime locale. | `project/locales/he.default.json` rename to `project/locales/he.json`, plus state/handoff if activated. | Locale parity check; Theme Check. |
| UNIT-191 | Repair invalid prompt template URL. | PROPOSED | `page.stone-runtime-prompt.json` no longer uses the invalid `shopify://pages` URL setting value. | `project/templates/page.stone-runtime-prompt.json`, plus state/handoff if activated. | JSON parse; Theme Check. |
| UNIT-192 | Re-run remote proof with no-delete protection. | PROPOSED | Existing theme id `156487712965` accepts the full theme root without rejected files while preserving remote-only gift card files. | Shopify CLI operation with `--nodelete` against unpublished theme only. | Upload output; theme list; preview URL. |
| UNIT-193 | Triage non-blocking Theme Check warnings. | PROPOSED | Remaining warnings are either fixed in narrow files or logged as accepted debt. | Files named by warnings only. | Theme Check warning summary before/after. |
...
| UNIT-189 | Push repaired source to unpublished `Stonev2`. | PLANNED | Existing unpublished theme id `156487712965` accepts full theme upload without rejected files or records exact remote blockers. | Shopify CLI operation, `state/`, `workspace/handoff/CURRENT_HANDOFF.md` | Shopify upload output and theme list | 2026-04-24 Asia/Jerusalem |
| UNIT-190 | Repair Hebrew runtime locale filename. | PLANNED | Runtime Hebrew locale is stored in a non-default locale file so Shopify has only one default runtime locale. | `project/locales/he.default.json`, `project/locales/he.json`, `state/`, `workspace/handoff/CURRENT_HANDOFF.md` | Remote push error evidence; locale parity check; Theme Check | 2026-04-24 Asia/Jerusalem |
| UNIT-191 | Repair invalid prompt template URL. | PLANNED | `page.stone-runtime-prompt.json` no longer uses the invalid `shopify://pages` URL setting value. | `project/templates/page.stone-runtime-prompt.json`, `state/`, `workspace/handoff/CURRENT_HANDOFF.md` | Remote push error evidence; JSON parse; Theme Check | 2026-04-24 Asia/Jerusalem |
| UNIT-192 | Re-run remote proof with no-delete protection. | PLANNED | Existing unpublished theme id `156487712965` accepts full theme upload without rejected files while preserving remote-only gift card files. | Shopify CLI operation, `state/`, `workspace/handoff/CURRENT_HANDOFF.md` | Shopify upload output and theme list | 2026-04-24 Asia/Jerusalem |
| UNIT-193 | Triage non-blocking Theme Check warnings. | PLANNED | Remaining warnings are either fixed narrowly or logged as accepted debt. | Files named by Theme Check warnings, `state/`, `workspace/handoff/CURRENT_HANDOFF.md` | Theme Check warning summary | 2026-04-24 Asia/Jerusalem |
```
