# Phase 4 Collection Filter Capability Boundary Checks v1

- `Verified`: Keep the unit docs-only.
- `Verified`: Record current collection capabilities.
- `Verified`: Decide native filter/facet capability boundary.
- `Verified`: Keep final preset assignment deferred.
- `Verified`: Keep JavaScript filtering, predictive search, recommendations, cart, checkout, and hardening blocked.
