# Phase 2 Collection Companion Boundary Checks v1

- `Verified`: Create all five planning artifacts inside `workspace/plans/phase-2-collection-companion-boundary-v1/`.
...
- `Verified`: Record exact preserved rules.
- `Verified`: Record the exact new allowance.
- `Verified`: Record the exact future runtime file scope.
