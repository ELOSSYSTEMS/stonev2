# Phase 3 Post Shoppable Media Motion Story Frontier Review Checks v1

- `Verified`: Create all five planning artifacts inside `workspace/plans/phase-3-post-shoppable-media-motion-story-frontier-review-v1/`.
...
- `Verified`: Record the approved next planning problem.
