# Phase 4 PDP Host And Behavior Reopen Evidence Checks v1

- `Verified`: Create all five planning artifacts inside `workspace/plans/phase-4-pdp-host-and-behavior-reopen-evidence-v1/`.
- `Verified`: Keep all edits docs-only in `workspace/plans/`, `state/`, and `workspace/handoff/CURRENT_HANDOFF.md`.
- `Verified`: Compare keep-blocked, narrow PDP reopen, and broad PDP reopen.
- `Verified`: Re-state wider-JS, heavier-commerce, and deferred-PDP constraints explicitly.
