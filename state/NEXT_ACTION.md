...
- `UNIT-098` Author the post-featured-product-showcase merchandising frontier review.

## Objective

- `Verified`: Re-evaluate the merchandising family after the verified featured-product showcase slice.
