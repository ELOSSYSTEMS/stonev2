...
- URL: https://elegance-canvas.myshopify.com/fr/collections/masterpiece-moments
- Title: Moments de chefs-d'œuvre – Elegance-canvas
- Body classes: gradient
- Custom elements: facet-filters, localization-form, predictive-search, shop-cart-sync
- Headings: Votre panier | Votre panier est vide | Recherche | Menu | Moments de chefs-d'œuvre | Harmonie numérique | Fleurs amicales | Golden Spring | Beauté gracieuse | Tous les filtres | Join our creative community

## 1. shopify-section-template--19562840981686__main

- Tag: div
- Classes: shopify-section
- Headings: Harmonie numérique | Fleurs amicales | Golden Spring | Beauté gracieuse | Tous les filtres
...
<path d="M11.1966 11.2414C10.8024 9.48613 9.20495 8.16852 7.29868 8.16852C5.39241 8.16852 3.79503 9.48613 3.40077 11.2414C3.33972 11.5131 3.30664 11.7949 3.30664 12.0842C3.30664 12.3735 3.33972 12.6554 3.40077 12.927C3.79492 14.6824 5.39241 16 7.29868 16C9.20495 16 10.8023 14.6823 11.1966 12.927C11.2576 12.6554 11.2907 12.3736 11.2907 12.0842C11.2907 11.7948 11.2576 11.513 11.1966 11.2414ZM7.29868 14.3145C6.04505 14.3145 5.02507 13.314 5.02507 12.0843C5.02507 10.8546 6.04505 9.85412 7.29868 9.85412C8.55231 9.85412 9.57228 10.8546 9.57228 12.0843C9.57228 13.314 8.55231 14.3145 7.29868 14.3145Z"></path>
            ...
            <div class="sort d-flex align-items-center justify-content-end flex-wrap">
                ...
                <div class="product_count me-5">
                  <span class="filter_totalcount">4
      ...
      <div class="clear-filters m-0">
        <div class="filter_results">
          <p class="d-inline-block mb-0 remove_filter rounded-pill d-none">
              ...
              <a href="/fr/collections/masterpiece-moments?sort_by=" class="active-filters__clear border-0 btn remove_all rounded-0 text-capitalize text-decoration-underline">Supprimer tout</a>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        ...
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle1" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="En stock" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 pouces" id="Filter-filter.v.option.size-1-filterEle1" data-compare="Filter-filter.v.option.size-12*24 pouces" data-count="4" aria-label="12*24 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 pouces" id="Filter-filter.v.option.size-2-filterEle1" data-compare="Filter-filter.v.option.size-12*48 pouces" data-count="4" aria-label="12*48 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 pouces" id="Filter-filter.v.option.size-3-filterEle1" data-compare="Filter-filter.v.option.size-24*48 pouces" data-count="4" aria-label="24*48 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 pouces" id="Filter-filter.v.option.size-4-filterEle1" data-compare="Filter-filter.v.option.size-48*96 pouces" data-count="4" aria-label="48*96 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bambou" id="Filter-filter.v.option.material-2-filterEle1" data-compare="Filter-filter.v.option.material-Bambou" data-count="2" aria-label="Bambou" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle1">Bambou
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois de pin" id="Filter-filter.v.option.material-3-filterEle1" data-compare="Filter-filter.v.option.material-Bois de pin" data-count="3" aria-label="Bois de pin" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle1">Bois de pin
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois de récupération" id="Filter-filter.v.option.material-4-filterEle1" data-compare="Filter-filter.v.option.material-Bois de récupération" data-count="3" aria-label="Bois de récupération" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle1">Bois de récupération
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois massif" id="Filter-filter.v.option.material-5-filterEle1" data-compare="Filter-filter.v.option.material-Bois massif" data-count="3" aria-label="Bois massif" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle1">Bois massif
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois sculpté" id="Filter-filter.v.option.material-6-filterEle1" data-compare="Filter-filter.v.option.material-Bois sculpté" data-count="1" aria-label="Bois sculpté" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle1">Bois sculpté
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Cadre doré" id="Filter-filter.v.option.material-7-filterEle1" data-compare="Filter-filter.v.option.material-Cadre doré" data-count="1" aria-label="Cadre doré" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle1">Cadre doré
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Cadre texturé" id="Filter-filter.v.option.material-8-filterEle1" data-compare="Filter-filter.v.option.material-Cadre texturé" data-count="1" aria-label="Cadre texturé" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle1">Cadre texturé
                              <span class="filter_counts ">(1)</span>
                            </label>
        ...
        <div class="product-check" hidden=""><label for="hidElemenet-filter-filter.v.availability-1" class="visually-hidden">filter.v.availability</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.availability-1" data-param="filter.v.availability" data-id="Filter-filter.v.availability-1" value="4" style=""><label for="hidElemenet-filter-filter.v.availability-0" class="visually-hidden">filter.v.availability</label>
              ...
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-12*24 pouces" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*24 pouces" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-12*48 pouces" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-12*48 pouces" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*48 pouces" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-24*48 pouces" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-24*48 pouces" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-24*48 pouces" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-48*96 pouces" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-48*96 pouces" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-48*96 pouces" value="4" style=""><label for="hidElemenet-filter-filter.v.option.material-Acier inoxydable" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Acier inoxydable" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Acier inoxydable" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Bambou" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Bambou" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bambou" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Bois de pin" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Bois de pin" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bois de pin" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Bois de récupération" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Bois de récupération" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bois de récupération" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Bois massif" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Bois massif" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bois massif" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Bois sculpté" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Bois sculpté" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bois sculpté" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Cadre doré" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Cadre doré" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Cadre doré" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Cadre texturé" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Cadre texturé" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Cadre texturé" value="1" style=""></div>
                ...
                <div style="list-style:none;" class="collapse-filter_v_availability  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle2" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="En stock" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_size  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 pouces" id="Filter-filter.v.option.size-1-filterEle2" data-compare="Filter-filter.v.option.size-12*24 pouces" data-count="4" aria-label="12*24 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 pouces" id="Filter-filter.v.option.size-2-filterEle2" data-compare="Filter-filter.v.option.size-12*48 pouces" data-count="4" aria-label="12*48 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 pouces" id="Filter-filter.v.option.size-3-filterEle2" data-compare="Filter-filter.v.option.size-24*48 pouces" data-count="4" aria-label="24*48 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 pouces" id="Filter-filter.v.option.size-4-filterEle2" data-compare="Filter-filter.v.option.size-48*96 pouces" data-count="4" aria-label="48*96 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bambou" id="Filter-filter.v.option.material-2-filterEle2" data-compare="Filter-filter.v.option.material-Bambou" data-count="2" aria-label="Bambou" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle2">Bambou
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois de pin" id="Filter-filter.v.option.material-3-filterEle2" data-compare="Filter-filter.v.option.material-Bois de pin" data-count="3" aria-label="Bois de pin" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle2">Bois de pin
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois de récupération" id="Filter-filter.v.option.material-4-filterEle2" data-compare="Filter-filter.v.option.material-Bois de récupération" data-count="3" aria-label="Bois de récupération" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle2">Bois de récupération
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois massif" id="Filter-filter.v.option.material-5-filterEle2" data-compare="Filter-filter.v.option.material-Bois massif" data-count="3" aria-label="Bois massif" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle2">Bois massif
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois sculpté" id="Filter-filter.v.option.material-6-filterEle2" data-compare="Filter-filter.v.option.material-Bois sculpté" data-count="1" aria-label="Bois sculpté" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle2">Bois sculpté
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Cadre doré" id="Filter-filter.v.option.material-7-filterEle2" data-compare="Filter-filter.v.option.material-Cadre doré" data-count="1" aria-label="Cadre doré" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle2">Cadre doré
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Cadre texturé" id="Filter-filter.v.option.material-8-filterEle2" data-compare="Filter-filter.v.option.material-Cadre texturé" data-count="1" aria-label="Cadre texturé" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle2">Cadre texturé
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<style data-shopify="">
  ...
  <div data-availablecheck="true" data-stockcount="5" class="fadeInUp card color-scheme-3 bg-transparent h-100 secondary_image">
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      <div class="image_wrapper ratio ratio-3x4" style=" --aspect-ratio:120.15384615384615%;">
        <a href="/fr/products/friendly-blossoms" class="card-img" aria-label="Fleurs amicales">
      ...
      <div class="tags position-absolute top-0 start-0 m-2 m-sm-3 z-1 d-grid gap-2">
        ...
        <div class="icon_container position-absolute top-0 end-0 z-1 m-2 m-sm-3 d-grid gap-2">
            ...
            <button class="popup-modal popup-modal- quick-view border-0 d-none d-md-flex justify-content-center align-items-center" id="quick-view-8095402066102" data-url="/fr/products/friendly-blossoms" data-sectionid="template--19562840981686__main" data-productid="8095402066102" data-producthandle="friendly-blossoms" aria-label="Aperçu rapide" data-currencysymbol="Rs." data-quickviewtype="popup" data-unitprice="
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095402066102">
        <a href="/fr/products/friendly-blossoms" id="CardLink-template--19562840981686__main-8095402066102" aria-labelledby="CardLink-template--19562840981686__main-8095402066102 " class="text-decoration-none">
          Fleurs amicales
        </a>
      </h3>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle3" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="En stock" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 pouces" id="Filter-filter.v.option.size-1-filterEle3" data-compare="Filter-filter.v.option.size-12*24 pouces" data-count="4" aria-label="12*24 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 pouces" id="Filter-filter.v.option.size-2-filterEle3" data-compare="Filter-filter.v.option.size-12*48 pouces" data-count="4" aria-label="12*48 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 pouces" id="Filter-filter.v.option.size-3-filterEle3" data-compare="Filter-filter.v.option.size-24*48 pouces" data-count="4" aria-label="24*48 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 pouces" id="Filter-filter.v.option.size-4-filterEle3" data-compare="Filter-filter.v.option.size-48*96 pouces" data-count="4" aria-label="48*96 pouces" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bambou" id="Filter-filter.v.option.material-2-filterEle3" data-compare="Filter-filter.v.option.material-Bambou" data-count="2" aria-label="Bambou" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle3">Bambou
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois de pin" id="Filter-filter.v.option.material-3-filterEle3" data-compare="Filter-filter.v.option.material-Bois de pin" data-count="3" aria-label="Bois de pin" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle3">Bois de pin
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois de récupération" id="Filter-filter.v.option.material-4-filterEle3" data-compare="Filter-filter.v.option.material-Bois de récupération" data-count="3" aria-label="Bois de récupération" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle3">Bois de récupération
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois massif" id="Filter-filter.v.option.material-5-filterEle3" data-compare="Filter-filter.v.option.material-Bois massif" data-count="3" aria-label="Bois massif" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle3">Bois massif
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bois sculpté" id="Filter-filter.v.option.material-6-filterEle3" data-compare="Filter-filter.v.option.material-Bois sculpté" data-count="1" aria-label="Bois sculpté" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle3">Bois sculpté
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Cadre doré" id="Filter-filter.v.option.material-7-filterEle3" data-compare="Filter-filter.v.option.material-Cadre doré" data-count="1" aria-label="Cadre doré" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle3">Cadre doré
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Cadre texturé" id="Filter-filter.v.option.material-8-filterEle3" data-compare="Filter-filter.v.option.material-Cadre texturé" data-count="1" aria-label="Cadre texturé" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle3">Cadre texturé
                              <span class="filter_counts ">(1)</span>
                            </label>
