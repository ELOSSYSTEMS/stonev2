...
- URL: https://elegance-canvas.myshopify.com/collections/framed-art-prints
- Title: Framed Art Prints – Elegance-canvas
- Body classes: gradient
- Custom elements: facet-filters, localization-form, predictive-search, shop-cart-sync
- Headings: Cart | Your cart is empty | Search | Menu | Framed Art Prints | The Ballet Beauty | Digital Harmony | Moonlit Breeze | The Village Journey | The White Lady | Golden Spring | All filters | Join our creative community

## 1. shopify-section-template--19562840981686__main

- Tag: div
- Classes: shopify-section
- Headings: The Ballet Beauty | Digital Harmony | Moonlit Breeze | The Village Journey | The White Lady | Golden Spring
...
<path d="M11.1966 11.2414C10.8024 9.48613 9.20495 8.16852 7.29868 8.16852C5.39241 8.16852 3.79503 9.48613 3.40077 11.2414C3.33972 11.5131 3.30664 11.7949 3.30664 12.0842C3.30664 12.3735 3.33972 12.6554 3.40077 12.927C3.79492 14.6824 5.39241 16 7.29868 16C9.20495 16 10.8023 14.6823 11.1966 12.927C11.2576 12.6554 11.2907 12.3736 11.2907 12.0842C11.2907 11.7948 11.2576 11.513 11.1966 11.2414ZM7.29868 14.3145C6.04505 14.3145 5.02507 13.314 5.02507 12.0843C5.02507 10.8546 6.04505 9.85412 7.29868 9.85412C8.55231 9.85412 9.57228 10.8546 9.57228 12.0843C9.57228 13.314 8.55231 14.3145 7.29868 14.3145Z"></path>
  ...
  <path d="M0 8H8V10H0V8Z" fill="currentColor"></path>
                    ...
                    <div class="dropdown sorting_duplicate px-0 py-1">
                      <button class="btn border-0 dropdown-toggle px-0 py-2 ps-sm-2 d-flex gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">Best selling</button>
      ...
      <div class="clear-filters m-0">
        <div class="filter_results">
          <p class="d-inline-block mb-0 remove_filter rounded-pill d-none">
              ...
              <a href="/collections/framed-art-prints?sort_by=" class="active-filters__clear border-0 btn remove_all rounded-0 text-capitalize text-decoration-underline">Remove all</a>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        ...
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle1" data-compare="Filter-filter.v.availability-1" data-count="19" aria-label="In stock" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_p_tag" class="collapse-filter_p_tag collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Prints" id="Filter-filter.p.tag-1-filterEle1" data-compare="Filter-filter.p.tag-Prints" data-count="19" aria-label="Prints" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Visual Artwork" id="Filter-filter.p.tag-2-filterEle1" data-compare="Filter-filter.p.tag-Visual Artwork" data-count="19" aria-label="Visual Artwork" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inches" id="Filter-filter.v.option.size-1-filterEle1" data-compare="Filter-filter.v.option.size-12*24 inches" data-count="19" aria-label="12*24 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inches" id="Filter-filter.v.option.size-2-filterEle1" data-compare="Filter-filter.v.option.size-12*48 inches" data-count="19" aria-label="12*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inches" id="Filter-filter.v.option.size-3-filterEle1" data-compare="Filter-filter.v.option.size-24*48 inches" data-count="19" aria-label="24*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inches" id="Filter-filter.v.option.size-4-filterEle1" data-compare="Filter-filter.v.option.size-48*96 inches" data-count="19" aria-label="48*96 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="cotton" id="Filter-filter.v.option.material-4-filterEle1" data-compare="Filter-filter.v.option.material-cotton" data-count="1" aria-label="cotton" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle1">cotton
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Custom-Built Frame" id="Filter-filter.v.option.material-5-filterEle1" data-compare="Filter-filter.v.option.material-Custom-Built Frame" data-count="1" aria-label="Custom-Built Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle1">Custom-Built Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gilded Frame" id="Filter-filter.v.option.material-6-filterEle1" data-compare="Filter-filter.v.option.material-Gilded Frame" data-count="7" aria-label="Gilded Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle1">Gilded Frame
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Lacquered Frame" id="Filter-filter.v.option.material-7-filterEle1" data-compare="Filter-filter.v.option.material-Lacquered Frame" data-count="4" aria-label="Lacquered Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle1">Lacquered Frame
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Pine Wood" id="Filter-filter.v.option.material-8-filterEle1" data-compare="Filter-filter.v.option.material-Pine Wood" data-count="11" aria-label="Pine Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle1">Pine Wood
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Reclaimed Wood" id="Filter-filter.v.option.material-9-filterEle1" data-compare="Filter-filter.v.option.material-Reclaimed Wood" data-count="10" aria-label="Reclaimed Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle1">Reclaimed Wood
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Rubber" id="Filter-filter.v.option.material-10-filterEle1" data-compare="Filter-filter.v.option.material-Rubber" data-count="1" aria-label="Rubber" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle1">Rubber
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Soft silk" id="Filter-filter.v.option.material-11-filterEle1" data-compare="Filter-filter.v.option.material-Soft silk" data-count="1" aria-label="Soft silk" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-11-filterEle1">Soft silk
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Solid Wood" id="Filter-filter.v.option.material-12-filterEle1" data-compare="Filter-filter.v.option.material-Solid Wood" data-count="11" aria-label="Solid Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-12-filterEle1">Solid Wood
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Stainless Steel" id="Filter-filter.v.option.material-13-filterEle1" data-compare="Filter-filter.v.option.material-Stainless Steel" data-count="7" aria-label="Stainless Steel" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-13-filterEle1">Stainless Steel
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Textured Frame" id="Filter-filter.v.option.material-14-filterEle1" data-compare="Filter-filter.v.option.material-Textured Frame" data-count="6" aria-label="Textured Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-14-filterEle1">Textured Frame
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Watercolor Painting" id="Filter-filter.v.option.material-15-filterEle1" data-compare="Filter-filter.v.option.material-Watercolor Painting" data-count="1" aria-label="Watercolor Painting" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-15-filterEle1">Watercolor Painting
                              <span class="filter_counts ">(1)</span>
                            </label>
        ...
        <div class="product-check" hidden=""><label for="hidElemenet-filter-filter.v.availability-1" class="visually-hidden">filter.v.availability</label>
              ...
              <input aria-label="19" type="text" id="hidElemenet-filter-filter.p.tag-Prints" data-param="filter.p.tag" data-id="Filter-filter.p.tag-Prints" value="19" style=""><label for="hidElemenet-filter-filter.p.tag-Visual Artwork" class="visually-hidden">filter.p.tag</label>
              <input aria-label="19" type="text" id="hidElemenet-filter-filter.p.tag-Visual Artwork" data-param="filter.p.tag" data-id="Filter-filter.p.tag-Visual Artwork" value="19" style=""><label for="hidElemenet-filter-filter.v.option.size-12*24 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="19" type="text" id="hidElemenet-filter-filter.v.option.size-12*24 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*24 inches" value="19" style=""><label for="hidElemenet-filter-filter.v.option.size-12*48 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="19" type="text" id="hidElemenet-filter-filter.v.option.size-12*48 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*48 inches" value="19" style=""><label for="hidElemenet-filter-filter.v.option.size-24*48 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="19" type="text" id="hidElemenet-filter-filter.v.option.size-24*48 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-24*48 inches" value="19" style=""><label for="hidElemenet-filter-filter.v.option.size-48*96 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="19" type="text" id="hidElemenet-filter-filter.v.option.size-48*96 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-48*96 inches" value="19" style=""><label for="hidElemenet-filter-filter.v.option.material-Aluminum" class="visually-hidden">filter.v.option.material</label>
              ...
              <input aria-label="7" type="text" id="hidElemenet-filter-filter.v.option.material-Carved Wood" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Carved Wood" value="7" style=""><label for="hidElemenet-filter-filter.v.option.material-cotton" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-cotton" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-cotton" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Custom-Built Frame" class="visually-hidden">filter.v.option.material</label>
              ...
              <input aria-label="10" type="text" id="hidElemenet-filter-filter.v.option.material-Reclaimed Wood" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Reclaimed Wood" value="10" style=""><label for="hidElemenet-filter-filter.v.option.material-Rubber" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Rubber" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Rubber" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Soft silk" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Soft silk" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Soft silk" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Solid Wood" class="visually-hidden">filter.v.option.material</label>
              ...
              <input aria-label="6" type="text" id="hidElemenet-filter-filter.v.option.material-Textured Frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Textured Frame" value="6" style=""><label for="hidElemenet-filter-filter.v.option.material-Watercolor Painting" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Watercolor Painting" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Watercolor Painting" value="1" style=""></div>
                ...
                <div style="list-style:none;" class="collapse-filter_v_availability  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle2" data-compare="Filter-filter.v.availability-1" data-count="19" aria-label="In stock" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_p_tag  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Prints" id="Filter-filter.p.tag-1-filterEle2" data-compare="Filter-filter.p.tag-Prints" data-count="19" aria-label="Prints" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Visual Artwork" id="Filter-filter.p.tag-2-filterEle2" data-compare="Filter-filter.p.tag-Visual Artwork" data-count="19" aria-label="Visual Artwork" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_size  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inches" id="Filter-filter.v.option.size-1-filterEle2" data-compare="Filter-filter.v.option.size-12*24 inches" data-count="19" aria-label="12*24 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inches" id="Filter-filter.v.option.size-2-filterEle2" data-compare="Filter-filter.v.option.size-12*48 inches" data-count="19" aria-label="12*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inches" id="Filter-filter.v.option.size-3-filterEle2" data-compare="Filter-filter.v.option.size-24*48 inches" data-count="19" aria-label="24*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inches" id="Filter-filter.v.option.size-4-filterEle2" data-compare="Filter-filter.v.option.size-48*96 inches" data-count="19" aria-label="48*96 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="cotton" id="Filter-filter.v.option.material-4-filterEle2" data-compare="Filter-filter.v.option.material-cotton" data-count="1" aria-label="cotton" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle2">cotton
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Custom-Built Frame" id="Filter-filter.v.option.material-5-filterEle2" data-compare="Filter-filter.v.option.material-Custom-Built Frame" data-count="1" aria-label="Custom-Built Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle2">Custom-Built Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gilded Frame" id="Filter-filter.v.option.material-6-filterEle2" data-compare="Filter-filter.v.option.material-Gilded Frame" data-count="7" aria-label="Gilded Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle2">Gilded Frame
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Lacquered Frame" id="Filter-filter.v.option.material-7-filterEle2" data-compare="Filter-filter.v.option.material-Lacquered Frame" data-count="4" aria-label="Lacquered Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle2">Lacquered Frame
                              <span class="filter_counts ">(4)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Pine Wood" id="Filter-filter.v.option.material-8-filterEle2" data-compare="Filter-filter.v.option.material-Pine Wood" data-count="11" aria-label="Pine Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle2">Pine Wood
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Reclaimed Wood" id="Filter-filter.v.option.material-9-filterEle2" data-compare="Filter-filter.v.option.material-Reclaimed Wood" data-count="10" aria-label="Reclaimed Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle2">Reclaimed Wood
                              <span class="filter_counts ">(10)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Rubber" id="Filter-filter.v.option.material-10-filterEle2" data-compare="Filter-filter.v.option.material-Rubber" data-count="1" aria-label="Rubber" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle2">Rubber
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Soft silk" id="Filter-filter.v.option.material-11-filterEle2" data-compare="Filter-filter.v.option.material-Soft silk" data-count="1" aria-label="Soft silk" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-11-filterEle2">Soft silk
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Solid Wood" id="Filter-filter.v.option.material-12-filterEle2" data-compare="Filter-filter.v.option.material-Solid Wood" data-count="11" aria-label="Solid Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-12-filterEle2">Solid Wood
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Stainless Steel" id="Filter-filter.v.option.material-13-filterEle2" data-compare="Filter-filter.v.option.material-Stainless Steel" data-count="7" aria-label="Stainless Steel" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-13-filterEle2">Stainless Steel
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Textured Frame" id="Filter-filter.v.option.material-14-filterEle2" data-compare="Filter-filter.v.option.material-Textured Frame" data-count="6" aria-label="Textured Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-14-filterEle2">Textured Frame
                              <span class="filter_counts ">(6)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Watercolor Painting" id="Filter-filter.v.option.material-15-filterEle2" data-compare="Filter-filter.v.option.material-Watercolor Painting" data-count="1" aria-label="Watercolor Painting" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-15-filterEle2">Watercolor Painting
                              <span class="filter_counts ">(1)</span>
                            </label>
  ...
  <div data-availablecheck="true" data-stockcount="100" class="fadeInUp card color-scheme-3 bg-transparent h-100 secondary_image">
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      <div class="image_wrapper ratio ratio-3x4" style=" --aspect-ratio:120.15384615384615%;">
        <a href="/products/the-ballet-beauty" class="card-img" aria-label="The Ballet Beauty">
          
            <img src="//elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=1280" alt="The Ballet Beauty" srcset="//elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=320 320w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=540 540w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=600 600w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=713 713w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=823 823w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=990 990w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=1100 1100w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_01_1.jpg?v=1753776354&amp;width=1206 1206w" width="1300" height="1562" loading="lazy" aria_hidden="true" fetchpriority="high" sizes="(max-width: 767px) 100vw, (min-width: 768px) calc((100vw - 120px) / 2), (min-width: 992px) calc((100vw - 130px) / 3), (min-width: 1200px) 650px" class="product-image img-fluid primary_image">
          

          
            <img src="//elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=1280" alt="The Ballet Beauty" srcset="//elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=320 320w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=540 540w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=600 600w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=713 713w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=823 823w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=990 990w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=1100 1100w, //elegance-canvas.myshopify.com/cdn/shop/files/Product10_02.jpg?v=1766225924&amp;width=1206 1206w" width="1300" height="1562" loading="lazy" aria_hidden="true" sizes="(min-width: 1200px) 650px, (min-width: 992px) calc((100vw - 130px) / 3), (min-width: 768px) calc((100vw - 120px) / 2), calc((100vw - 35px) / 2)" class="img-fluid secondary_image">
      ...
      <div class="tags position-absolute top-0 start-0 m-2 m-sm-3 z-1 d-grid gap-2">
        ...
        <div class="icon_container position-absolute top-0 end-0 z-1 m-2 m-sm-3 d-grid gap-2">
            ...
            <button class="popup-modal popup-modal- quick-view border-0 d-none d-md-flex justify-content-center align-items-center" id="quick-view-8095401803958" data-url="/products/the-ballet-beauty" data-sectionid="template--19562840981686__main" data-productid="8095401803958" data-producthandle="the-ballet-beauty" aria-label="Quick view" data-currencysymbol="Rs." data-quickviewtype="popup" data-unitprice="
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095401803958">
        <a href="/products/the-ballet-beauty" id="CardLink-template--19562840981686__main-8095401803958" aria-labelledby="CardLink-template--19562840981686__main-8095401803958 " class="text-decoration-none">
          The Ballet Beauty
        </a>
      </h3>
    ...
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      ...
      <div class="tags position-absolute top-0 start-0 m-2 m-sm-3 z-1 d-grid gap-2">
        ...
        <div class="icon_container position-absolute top-0 end-0 z-1 m-2 m-sm-3 d-grid gap-2">
            ...
            <button class="popup-modal popup-modal- quick-view border-0 d-none d-md-flex justify-content-center align-items-center" id="quick-view-8095403049142" data-url="/products/digital-harmony" data-sectionid="template--19562840981686__main" data-productid="8095403049142" data-producthandle="digital-harmony" aria-label="Quick view" data-currencysymbol="Rs." data-quickviewtype="popup" data-unitprice="
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095403049142">
        <a href="/products/digital-harmony" id="CardLink-template--19562840981686__main-8095403049142" aria-labelledby="CardLink-template--19562840981686__main-8095403049142 " class="text-decoration-none">
          Digital Harmony
        </a>
      </h3>
    ...
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      ...
      <div class="tags position-absolute top-0 start-0 m-2 m-sm-3 z-1 d-grid gap-2">
        ...
        <div class="icon_container position-absolute top-0 end-0 z-1 m-2 m-sm-3 d-grid gap-2">
            ...
            <button class="popup-modal popup-modal- quick-view border-0 d-none d-md-flex justify-content-center align-items-center" id="quick-view-8095402918070" data-url="/products/the-village-journey" data-sectionid="template--19562840981686__main" data-productid="8095402918070" data-producthandle="the-village-journey" aria-label="Quick view" data-currencysymbol="Rs." data-quickviewtype="popup" data-unitprice="
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095402918070">
        <a href="/products/the-village-journey" id="CardLink-template--19562840981686__main-8095402918070" aria-labelledby="CardLink-template--19562840981686__main-8095402918070 " class="text-decoration-none">
          The Village Journey
        </a>
      </h3>
...
<style data-shopify="">
  ...
  <div data-availablecheck="true" data-stockcount="5" class="fadeInUp card color-scheme-3 bg-transparent h-100 secondary_image">
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      <div class="image_wrapper ratio ratio-3x4" style=" --aspect-ratio:120.2051282051282%;">
        <a href="/products/the-white-lady" class="card-img" aria-label="The White Lady">
          
            <img src="//elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=1280" alt="The White Lady" srcset="//elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=320 320w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=540 540w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=600 600w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=713 713w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=823 823w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=990 990w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=1100 1100w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_01_a83c30eb-4352-48fc-b62d-85f756d2f14b.png?v=1751872076&amp;width=1206 1206w" width="975" height="1172" loading="lazy" aria_hidden="true" fetchpriority="high" sizes="(max-width: 767px) 100vw, (min-width: 768px) calc((100vw - 120px) / 2), (min-width: 992px) calc((100vw - 130px) / 3), (min-width: 1200px) 650px" class="product-image img-fluid primary_image">
          

          
            <img src="//elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=1280" alt="The White Lady" srcset="//elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=320 320w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=540 540w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=600 600w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=713 713w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=823 823w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=990 990w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=1100 1100w, //elegance-canvas.myshopify.com/cdn/shop/files/Product16_02_51410ca3-83f0-4b14-84f3-54bae86fe9b0.png?v=1734585294&amp;width=1206 1206w" width="975" height="1172" loading="lazy" aria_hidden="true" sizes="(min-width: 1200px) 650px, (min-width: 992px) calc((100vw - 130px) / 3), (min-width: 768px) calc((100vw - 120px) / 2), calc((100vw - 35px) / 2)" class="img-fluid secondary_image">
      ...
      <div class="tags position-absolute top-0 start-0 m-2 m-sm-3 z-1 d-grid gap-2">
        ...
        <div class="icon_container position-absolute top-0 end-0 z-1 m-2 m-sm-3 d-grid gap-2">
            ...
            <button class="popup-modal popup-modal- quick-view border-0 d-none d-md-flex justify-content-center align-items-center" id="quick-view-8095402786998" data-url="/products/the-white-lady" data-sectionid="template--19562840981686__main" data-productid="8095402786998" data-producthandle="the-white-lady" aria-label="Quick view" data-currencysymbol="Rs." data-quickviewtype="popup" data-unitprice="
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095402786998">
        <a href="/products/the-white-lady" id="CardLink-template--19562840981686__main-8095402786998" aria-labelledby="CardLink-template--19562840981686__main-8095402786998 " class="text-decoration-none">
          The White Lady
        </a>
      </h3>
...
<style data-shopify="">
  ...
  <div data-availablecheck="true" data-stockcount="10" class="fadeInUp card color-scheme-3 bg-transparent h-100 secondary_image">
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      <div class="image_wrapper ratio ratio-3x4" style=" --aspect-ratio:120.2051282051282%;">
        <a href="/products/golden-spring" class="card-img" aria-label="Golden Spring">
      ...
      <div class="tags position-absolute top-0 start-0 m-2 m-sm-3 z-1 d-grid gap-2">
        ...
        <div class="icon_container position-absolute top-0 end-0 z-1 m-2 m-sm-3 d-grid gap-2">
            ...
            <button class="popup-modal popup-modal- quick-view border-0 d-none d-md-flex justify-content-center align-items-center" id="quick-view-8095402688694" data-url="/products/golden-spring" data-sectionid="template--19562840981686__main" data-productid="8095402688694" data-producthandle="golden-spring" aria-label="Quick view" data-currencysymbol="Rs." data-quickviewtype="popup" data-unitprice="
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095402688694">
        <a href="/products/golden-spring" id="CardLink-template--19562840981686__main-8095402688694" aria-labelledby="CardLink-template--19562840981686__main-8095402688694 " class="text-decoration-none">
          Golden Spring
        </a>
      </h3>
...
<div class="product_price_info d-flex gap-2 flex-wrap">
      ...
      From
        ...
        Rs. 2,500.00
                    ...
                    <div class="pagination-container mt-3 mt-xl-5 text-center w-100 d-none">
                      <div class="pagination justify-content-center align-items-center flex-wrap"> <span class="page current">1</span> <span class="page"><a href="/collections/framed-art-prints?page=2" title="">2</a></span> <span class="page"><a href="/collections/framed-art-prints?page=3" title="">3</a></span> <span class="page"><a href="/collections/framed-art-prints?page=4" title="">4</a></span> <span class="next"><a href="/collections/framed-art-prints?page=2" title="">Next »</a></span> </div>
                    </div>
    ...
    <nav class="pt-5" role="navigation" aria-label="Pagination">
      <ul class="pagination pagination__list list-unstyled mb-0" role="list"><li class="page-item"><a role="link" aria-disabled="true" class="pagination__item page-link pagination__item--current light active" aria-current="page" aria-label="Page 1" data-link-target="2">
                 01</a></li><li class="page-item"><a href="/collections/framed-art-prints?page=2" class="pagination__item page-link" aria-label="Page 2" data-link-target="2">
                02</a></li><li class="page-item"><a href="/collections/framed-art-prints?page=3" class="pagination__item page-link" aria-label="Page 3" data-link-target="3">
                03</a></li><li class="page-item"><a href="/collections/framed-art-prints?page=4" class="pagination__item page-link" aria-label="Page 4" data-link-target="4">
                04</a></li><li class="page-item">
            <a href="/collections/framed-art-prints?page=2" class="pagination__item pagination__item--prev page-link" aria-label="Next page" data-link-target="2">
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle3" data-compare="Filter-filter.v.availability-1" data-count="19" aria-label="In stock" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_p_tag" class="collapse-filter_p_tag collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Prints" id="Filter-filter.p.tag-1-filterEle3" data-compare="Filter-filter.p.tag-Prints" data-count="19" aria-label="Prints" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Visual Artwork" id="Filter-filter.p.tag-2-filterEle3" data-compare="Filter-filter.p.tag-Visual Artwork" data-count="19" aria-label="Visual Artwork" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inches" id="Filter-filter.v.option.size-1-filterEle3" data-compare="Filter-filter.v.option.size-12*24 inches" data-count="19" aria-label="12*24 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inches" id="Filter-filter.v.option.size-2-filterEle3" data-compare="Filter-filter.v.option.size-12*48 inches" data-count="19" aria-label="12*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inches" id="Filter-filter.v.option.size-3-filterEle3" data-compare="Filter-filter.v.option.size-24*48 inches" data-count="19" aria-label="24*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inches" id="Filter-filter.v.option.size-4-filterEle3" data-compare="Filter-filter.v.option.size-48*96 inches" data-count="19" aria-label="48*96 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="cotton" id="Filter-filter.v.option.material-4-filterEle3" data-compare="Filter-filter.v.option.material-cotton" data-count="1" aria-label="cotton" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle3">cotton
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Custom-Built Frame" id="Filter-filter.v.option.material-5-filterEle3" data-compare="Filter-filter.v.option.material-Custom-Built Frame" data-count="1" aria-label="Custom-Built Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle3">Custom-Built Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gilded Frame" id="Filter-filter.v.option.material-6-filterEle3" data-compare="Filter-filter.v.option.material-Gilded Frame" data-count="7" aria-label="Gilded Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle3">Gilded Frame
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Lacquered Frame" id="Filter-filter.v.option.material-7-filterEle3" data-compare="Filter-filter.v.option.material-Lacquered Frame" data-count="4" aria-label="Lacquered Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle3">Lacquered Frame
                              <span class="filter_counts ">(4)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Pine Wood" id="Filter-filter.v.option.material-8-filterEle3" data-compare="Filter-filter.v.option.material-Pine Wood" data-count="11" aria-label="Pine Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle3">Pine Wood
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Reclaimed Wood" id="Filter-filter.v.option.material-9-filterEle3" data-compare="Filter-filter.v.option.material-Reclaimed Wood" data-count="10" aria-label="Reclaimed Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle3">Reclaimed Wood
                              <span class="filter_counts ">(10)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Rubber" id="Filter-filter.v.option.material-10-filterEle3" data-compare="Filter-filter.v.option.material-Rubber" data-count="1" aria-label="Rubber" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle3">Rubber
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Soft silk" id="Filter-filter.v.option.material-11-filterEle3" data-compare="Filter-filter.v.option.material-Soft silk" data-count="1" aria-label="Soft silk" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-11-filterEle3">Soft silk
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Solid Wood" id="Filter-filter.v.option.material-12-filterEle3" data-compare="Filter-filter.v.option.material-Solid Wood" data-count="11" aria-label="Solid Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-12-filterEle3">Solid Wood
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Stainless Steel" id="Filter-filter.v.option.material-13-filterEle3" data-compare="Filter-filter.v.option.material-Stainless Steel" data-count="7" aria-label="Stainless Steel" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-13-filterEle3">Stainless Steel
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Textured Frame" id="Filter-filter.v.option.material-14-filterEle3" data-compare="Filter-filter.v.option.material-Textured Frame" data-count="6" aria-label="Textured Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-14-filterEle3">Textured Frame
                              <span class="filter_counts ">(6)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Watercolor Painting" id="Filter-filter.v.option.material-15-filterEle3" data-compare="Filter-filter.v.option.material-Watercolor Painting" data-count="1" aria-label="Watercolor Painting" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-15-filterEle3">Watercolor Painting
                              <span class="filter_counts ">(1)</span>
                            </label>
