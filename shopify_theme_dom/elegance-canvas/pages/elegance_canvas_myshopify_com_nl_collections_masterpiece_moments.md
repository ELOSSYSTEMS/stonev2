...
- URL: https://elegance-canvas.myshopify.com/nl/collections/masterpiece-moments
- Title: Meesterlijke momenten – Elegance-canvas
- Body classes: gradient
- Custom elements: facet-filters, localization-form, predictive-search, shop-cart-sync
- Headings: Winkelwagen | Je winkelwagen is leeg. | Zoekopdracht | Menu | Meesterlijke momenten | Digitale Harmonie | Vriendelijke bloesems | Gouden Lente | Sierlijke schoonheid | Alle filters | Join our creative community

## 1. shopify-section-template--19562840981686__main

- Tag: div
- Classes: shopify-section
- Headings: Digitale Harmonie | Vriendelijke bloesems | Gouden Lente | Sierlijke schoonheid | Alle filters
      ...
      <div class="clear-filters m-0">
        <div class="filter_results">
          <p class="d-inline-block mb-0 remove_filter rounded-pill d-none">
              ...
              <a href="/nl/collections/masterpiece-moments?sort_by=" class="active-filters__clear border-0 btn remove_all rounded-0 text-capitalize text-decoration-underline">Remove all</a>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        ...
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle1" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="Op voorraad" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle1" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="4" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle1" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="4" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle1" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="4" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle1" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="4" aria-label="48*96 inch" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_material" class="collapse-filter_v_option_material collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-1-filterEle1" data-compare="Filter-filter.v.option.material-Bamboe" data-count="2" aria-label="Bamboe" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-1-filterEle1">Bamboe
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-2-filterEle1" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="3" aria-label="Gerecycled hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle1">Gerecycled hout
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-3-filterEle1" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="1" aria-label="Gesneden hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle1">Gesneden hout
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gestructureerd frame" id="Filter-filter.v.option.material-4-filterEle1" data-compare="Filter-filter.v.option.material-Gestructureerd frame" data-count="1" aria-label="Gestructureerd frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle1">Gestructureerd frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-5-filterEle1" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="3" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle1">Grenenhout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-6-filterEle1" data-compare="Filter-filter.v.option.material-Massief hout" data-count="3" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle1">Massief hout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-7-filterEle1" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="2" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle1">Roestvrij staal
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-8-filterEle1" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="1" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle1">Verguld frame
                              <span class="filter_counts ">(1)</span>
                            </label>
        ...
        <div class="product-check" hidden=""><label for="hidElemenet-filter-filter.v.availability-1" class="visually-hidden">filter.v.availability</label>
              ...
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-12*24 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*24 inch" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-12*48 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-12*48 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*48 inch" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-24*48 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-24*48 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-24*48 inch" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-48*96 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-48*96 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-48*96 inch" value="4" style=""><label for="hidElemenet-filter-filter.v.option.material-Bamboe" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Bamboe" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bamboe" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Gerecycled hout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Gerecycled hout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gerecycled hout" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Gesneden hout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Gesneden hout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gesneden hout" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Gestructureerd frame" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Gestructureerd frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gestructureerd frame" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Grenenhout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Grenenhout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Grenenhout" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Massief hout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Massief hout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Massief hout" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Roestvrij staal" class="visually-hidden">filter.v.option.material</label>
                ...
                <div style="list-style:none;" class="collapse-filter_v_availability  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle2" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="Op voorraad" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_size  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle2" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="4" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle2" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="4" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle2" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="4" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle2" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="4" aria-label="48*96 inch" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_material  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-1-filterEle2" data-compare="Filter-filter.v.option.material-Bamboe" data-count="2" aria-label="Bamboe" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-1-filterEle2">Bamboe
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-2-filterEle2" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="3" aria-label="Gerecycled hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle2">Gerecycled hout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-3-filterEle2" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="1" aria-label="Gesneden hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle2">Gesneden hout
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gestructureerd frame" id="Filter-filter.v.option.material-4-filterEle2" data-compare="Filter-filter.v.option.material-Gestructureerd frame" data-count="1" aria-label="Gestructureerd frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle2">Gestructureerd frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-5-filterEle2" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="3" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle2">Grenenhout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-6-filterEle2" data-compare="Filter-filter.v.option.material-Massief hout" data-count="3" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle2">Massief hout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-7-filterEle2" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="2" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle2">Roestvrij staal
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-8-filterEle2" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="1" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle2">Verguld frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<style data-shopify="">
  ...
  <div data-availablecheck="true" data-stockcount="5" class="fadeInUp card color-scheme-3 bg-transparent h-100 secondary_image">
    <div class="card-image overflow-hidden card_product_detail color-scheme-3 ">
      <div class="image_wrapper ratio ratio-3x4" style=" --aspect-ratio:120.15384615384615%;">
        <a href="/nl/products/friendly-blossoms" class="card-img" aria-label="Vriendelijke bloesems">
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095402066102">
        <a href="/nl/products/friendly-blossoms" id="CardLink-template--19562840981686__main-8095402066102" aria-labelledby="CardLink-template--19562840981686__main-8095402066102 " class="text-decoration-none">
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle3" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="Op voorraad" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle3" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="4" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle3" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="4" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle3" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="4" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle3" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="4" aria-label="48*96 inch" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_material" class="collapse-filter_v_option_material collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-1-filterEle3" data-compare="Filter-filter.v.option.material-Bamboe" data-count="2" aria-label="Bamboe" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-1-filterEle3">Bamboe
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-2-filterEle3" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="3" aria-label="Gerecycled hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle3">Gerecycled hout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-3-filterEle3" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="1" aria-label="Gesneden hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle3">Gesneden hout
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gestructureerd frame" id="Filter-filter.v.option.material-4-filterEle3" data-compare="Filter-filter.v.option.material-Gestructureerd frame" data-count="1" aria-label="Gestructureerd frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle3">Gestructureerd frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-5-filterEle3" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="3" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle3">Grenenhout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-6-filterEle3" data-compare="Filter-filter.v.option.material-Massief hout" data-count="3" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle3">Massief hout
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-7-filterEle3" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="2" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle3">Roestvrij staal
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-8-filterEle3" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="1" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle3">Verguld frame
                              <span class="filter_counts ">(1)</span>
                            </label>
