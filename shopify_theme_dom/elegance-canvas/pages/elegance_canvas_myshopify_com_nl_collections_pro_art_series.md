...
- URL: https://elegance-canvas.myshopify.com/nl/collections/pro-art-series
- Title: Pro Art-serie – Elegance-canvas
- Body classes: gradient
- Custom elements: facet-filters, localization-form, predictive-search, shop-cart-sync
- Headings: Winkelwagen | Je winkelwagen is leeg. | Zoekopdracht | Menu | Pro Art-serie | Maanlichtbries | Sierlijke schoonheid | Mona's Koffie | De Rebelse Muziek | De genade van de geisha | Tijdloze reflectie | Alle filters | Join our creative community

## 1. shopify-section-template--19562840981686__main

- Tag: div
- Classes: shopify-section
- Headings: Maanlichtbries | Sierlijke schoonheid | Mona's Koffie | De Rebelse Muziek | De genade van de geisha | Tijdloze reflectie
...
<path d="M11.1966 11.2414C10.8024 9.48613 9.20495 8.16852 7.29868 8.16852C5.39241 8.16852 3.79503 9.48613 3.40077 11.2414C3.33972 11.5131 3.30664 11.7949 3.30664 12.0842C3.30664 12.3735 3.33972 12.6554 3.40077 12.927C3.79492 14.6824 5.39241 16 7.29868 16C9.20495 16 10.8023 14.6823 11.1966 12.927C11.2576 12.6554 11.2907 12.3736 11.2907 12.0842C11.2907 11.7948 11.2576 11.513 11.1966 11.2414ZM7.29868 14.3145C6.04505 14.3145 5.02507 13.314 5.02507 12.0843C5.02507 10.8546 6.04505 9.85412 7.29868 9.85412C8.55231 9.85412 9.57228 10.8546 9.57228 12.0843C9.57228 13.314 8.55231 14.3145 7.29868 14.3145Z"></path>
  ...
  <path d="M0 8H8V10H0V8Z" fill="currentColor"></path>
                    ...
                    <div class="dropdown sorting_duplicate px-0 py-1">
                      <button class="btn border-0 dropdown-toggle px-0 py-2 ps-sm-2 d-flex gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">Datum: oud naar nieuw</button>
      ...
      <div class="clear-filters m-0">
        <div class="filter_results">
          <p class="d-inline-block mb-0 remove_filter rounded-pill d-none">
              ...
              <a href="/nl/collections/pro-art-series?sort_by=" class="active-filters__clear border-0 btn remove_all rounded-0 text-capitalize text-decoration-underline">Remove all</a>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        ...
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle1" data-compare="Filter-filter.v.availability-1" data-count="18" aria-label="Op voorraad" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle1" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="18" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle1" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="18" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle1" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="18" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle1" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="18" aria-label="48*96 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-2-filterEle1" data-compare="Filter-filter.v.option.material-Bamboe" data-count="5" aria-label="Bamboe" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle1">Bamboe
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Frame op maat gemaakt" id="Filter-filter.v.option.material-3-filterEle1" data-compare="Filter-filter.v.option.material-Frame op maat gemaakt" data-count="1" aria-label="Frame op maat gemaakt" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle1">Frame op maat gemaakt
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gelakt frame" id="Filter-filter.v.option.material-4-filterEle1" data-compare="Filter-filter.v.option.material-Gelakt frame" data-count="4" aria-label="Gelakt frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle1">Gelakt frame
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-5-filterEle1" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="10" aria-label="Gerecycled hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle1">Gerecycled hout
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-6-filterEle1" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="7" aria-label="Gesneden hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle1">Gesneden hout
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gestructureerd frame" id="Filter-filter.v.option.material-7-filterEle1" data-compare="Filter-filter.v.option.material-Gestructureerd frame" data-count="6" aria-label="Gestructureerd frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle1">Gestructureerd frame
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-8-filterEle1" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="11" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle1">Grenenhout
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-9-filterEle1" data-compare="Filter-filter.v.option.material-Massief hout" data-count="11" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle1">Massief hout
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-10-filterEle1" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="7" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle1">Roestvrij staal
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-11-filterEle1" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="7" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-11-filterEle1">Verguld frame
                              <span class="filter_counts ">(7)</span>
                            </label>
        ...
        <div class="product-check" hidden=""><label for="hidElemenet-filter-filter.v.availability-1" class="visually-hidden">filter.v.availability</label>
              ...
              <input aria-label="18" type="text" id="hidElemenet-filter-filter.v.option.size-12*24 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*24 inch" value="18" style=""><label for="hidElemenet-filter-filter.v.option.size-12*48 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="18" type="text" id="hidElemenet-filter-filter.v.option.size-12*48 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*48 inch" value="18" style=""><label for="hidElemenet-filter-filter.v.option.size-24*48 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="18" type="text" id="hidElemenet-filter-filter.v.option.size-24*48 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-24*48 inch" value="18" style=""><label for="hidElemenet-filter-filter.v.option.size-48*96 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="18" type="text" id="hidElemenet-filter-filter.v.option.size-48*96 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-48*96 inch" value="18" style=""><label for="hidElemenet-filter-filter.v.option.material-Aluminium" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Aluminium" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Aluminium" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Bamboe" class="visually-hidden">filter.v.option.material</label>
              ...
              <input aria-label="11" type="text" id="hidElemenet-filter-filter.v.option.material-Grenenhout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Grenenhout" value="11" style=""><label for="hidElemenet-filter-filter.v.option.material-Massief hout" class="visually-hidden">filter.v.option.material</label>
              ...
              <input aria-label="7" type="text" id="hidElemenet-filter-filter.v.option.material-Roestvrij staal" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Roestvrij staal" value="7" style=""><label for="hidElemenet-filter-filter.v.option.material-Verguld frame" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="7" type="text" id="hidElemenet-filter-filter.v.option.material-Verguld frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Verguld frame" value="7" style=""></div>
                ...
                <div style="list-style:none;" class="collapse-filter_v_availability  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle2" data-compare="Filter-filter.v.availability-1" data-count="18" aria-label="Op voorraad" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_size  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle2" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="18" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle2" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="18" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle2" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="18" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle2" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="18" aria-label="48*96 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-2-filterEle2" data-compare="Filter-filter.v.option.material-Bamboe" data-count="5" aria-label="Bamboe" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle2">Bamboe
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Frame op maat gemaakt" id="Filter-filter.v.option.material-3-filterEle2" data-compare="Filter-filter.v.option.material-Frame op maat gemaakt" data-count="1" aria-label="Frame op maat gemaakt" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle2">Frame op maat gemaakt
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gelakt frame" id="Filter-filter.v.option.material-4-filterEle2" data-compare="Filter-filter.v.option.material-Gelakt frame" data-count="4" aria-label="Gelakt frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle2">Gelakt frame
                              <span class="filter_counts ">(4)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-5-filterEle2" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="10" aria-label="Gerecycled hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle2">Gerecycled hout
                              <span class="filter_counts ">(10)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-6-filterEle2" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="7" aria-label="Gesneden hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle2">Gesneden hout
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gestructureerd frame" id="Filter-filter.v.option.material-7-filterEle2" data-compare="Filter-filter.v.option.material-Gestructureerd frame" data-count="6" aria-label="Gestructureerd frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle2">Gestructureerd frame
                              <span class="filter_counts ">(6)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-8-filterEle2" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="11" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle2">Grenenhout
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-9-filterEle2" data-compare="Filter-filter.v.option.material-Massief hout" data-count="11" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle2">Massief hout
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-10-filterEle2" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="7" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle2">Roestvrij staal
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-11-filterEle2" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="7" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-11-filterEle2">Verguld frame
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095400951990">
        <a href="/nl/products/graceful-beauty" id="CardLink-template--19562840981686__main-8095400951990" aria-labelledby="CardLink-template--19562840981686__main-8095400951990 " class="text-decoration-none">
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095401115830">
        <a href="/nl/products/mona-s-coffee" id="CardLink-template--19562840981686__main-8095401115830" aria-labelledby="CardLink-template--19562840981686__main-8095401115830 " class="text-decoration-none">
          Mona's Koffie
        </a>
      </h3>
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095401214134">
        <a href="/nl/products/the-rebel-music" id="CardLink-template--19562840981686__main-8095401214134" aria-labelledby="CardLink-template--19562840981686__main-8095401214134 " class="text-decoration-none">
          De Rebelse Muziek
        </a>
      </h3>
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095401279670">
        <a href="/nl/products/the-geisha-s-grace" id="CardLink-template--19562840981686__main-8095401279670" aria-labelledby="CardLink-template--19562840981686__main-8095401279670 " class="text-decoration-none">
...
<path d="M11 14.4375C9.10525 14.4375 7.5625 12.8948 7.5625 11C7.5625 9.10525 9.10525 7.5625 11 7.5625C12.8948 7.5625 14.4375 9.10525 14.4375 11C14.4375 12.8948 12.8948 14.4375 11 14.4375ZM11 8.9375C9.8615 8.9375 8.9375 9.8615 8.9375 11C8.9375 12.1385 9.8615 13.0625 11 13.0625C12.1385 13.0625 13.0625 12.1385 13.0625 11C13.0625 9.8615 12.1385 8.9375 11 8.9375Z" fill="currentcolor"></path>
    ...
    <div class="card-body   px-0">
      ...
      <h3 class="card-title h2 mb-1" id="title-template--19562840981686__main-8095401410742">
        <a href="/nl/products/timeless-reflection" id="CardLink-template--19562840981686__main-8095401410742" aria-labelledby="CardLink-template--19562840981686__main-8095401410742 " class="text-decoration-none">
          Tijdloze reflectie
        </a>
      </h3>
...
<div class="product_price_info d-flex gap-2 flex-wrap">
      ...
      <span class="low_price text-decoration-line-through">
          ...
          Rs. 6,000.00
                    ...
                    <div class="pagination-container mt-3 mt-xl-5 text-center w-100 d-none">
                      <div class="pagination justify-content-center align-items-center flex-wrap"> <span class="page current">1</span> <span class="page"><a href="/nl/collections/pro-art-series?page=2" title="">2</a></span> <span class="page"><a href="/nl/collections/pro-art-series?page=3" title="">3</a></span> <span class="next"><a href="/nl/collections/pro-art-series?page=2" title="">Volgende »</a></span> </div>
                    </div>
    ...
    <nav class="pt-5" role="navigation" aria-label="Paginering">
      <ul class="pagination pagination__list list-unstyled mb-0" role="list"><li class="page-item"><a role="link" aria-disabled="true" class="pagination__item page-link pagination__item--current light active" aria-current="page" aria-label="Pagina 1" data-link-target="2">
                 01</a></li><li class="page-item"><a href="/nl/collections/pro-art-series?page=2" class="pagination__item page-link" aria-label="Pagina 2" data-link-target="2">
                02</a></li><li class="page-item"><a href="/nl/collections/pro-art-series?page=3" class="pagination__item page-link" aria-label="Pagina 3" data-link-target="3">
                03</a></li><li class="page-item">
            <a href="/nl/collections/pro-art-series?page=2" class="pagination__item pagination__item--prev page-link" aria-label="Volgende pagina" data-link-target="2">
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle3" data-compare="Filter-filter.v.availability-1" data-count="18" aria-label="Op voorraad" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle3" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="18" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle3" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="18" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle3" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="18" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle3" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="18" aria-label="48*96 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-2-filterEle3" data-compare="Filter-filter.v.option.material-Bamboe" data-count="5" aria-label="Bamboe" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle3">Bamboe
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Frame op maat gemaakt" id="Filter-filter.v.option.material-3-filterEle3" data-compare="Filter-filter.v.option.material-Frame op maat gemaakt" data-count="1" aria-label="Frame op maat gemaakt" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle3">Frame op maat gemaakt
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gelakt frame" id="Filter-filter.v.option.material-4-filterEle3" data-compare="Filter-filter.v.option.material-Gelakt frame" data-count="4" aria-label="Gelakt frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle3">Gelakt frame
                              <span class="filter_counts ">(4)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-5-filterEle3" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="10" aria-label="Gerecycled hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle3">Gerecycled hout
                              <span class="filter_counts ">(10)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-6-filterEle3" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="7" aria-label="Gesneden hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle3">Gesneden hout
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gestructureerd frame" id="Filter-filter.v.option.material-7-filterEle3" data-compare="Filter-filter.v.option.material-Gestructureerd frame" data-count="6" aria-label="Gestructureerd frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle3">Gestructureerd frame
                              <span class="filter_counts ">(6)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-8-filterEle3" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="11" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle3">Grenenhout
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-9-filterEle3" data-compare="Filter-filter.v.option.material-Massief hout" data-count="11" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle3">Massief hout
                              <span class="filter_counts ">(11)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-10-filterEle3" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="7" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle3">Roestvrij staal
                              <span class="filter_counts ">(7)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-11-filterEle3" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="7" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-11-filterEle3">Verguld frame
                              <span class="filter_counts ">(7)</span>
                            </label>
