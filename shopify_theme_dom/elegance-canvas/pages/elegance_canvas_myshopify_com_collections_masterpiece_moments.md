...
- URL: https://elegance-canvas.myshopify.com/collections/masterpiece-moments
- Title: Masterpiece Moments – Elegance-canvas
- Body classes: gradient
- Custom elements: facet-filters, localization-form, predictive-search, shop-cart-sync
- Headings: Cart | Your cart is empty | Search | Menu | Masterpiece Moments | Digital Harmony | Friendly Blossoms | Golden Spring | Graceful Beauty | All filters | Join our creative community

## 1. shopify-section-template--19562840981686__main

- Tag: div
- Classes: shopify-section
- Headings: Digital Harmony | Friendly Blossoms | Golden Spring | Graceful Beauty | All filters
      ...
      <div class="clear-filters m-0">
        <div class="filter_results">
          <p class="d-inline-block mb-0 remove_filter rounded-pill d-none">
              ...
              <a href="/collections/masterpiece-moments?sort_by=" class="active-filters__clear border-0 btn remove_all rounded-0 text-capitalize text-decoration-underline">Remove all</a>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        ...
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle1" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="In stock" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_p_tag" class="collapse-filter_p_tag collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Prints" id="Filter-filter.p.tag-1-filterEle1" data-compare="Filter-filter.p.tag-Prints" data-count="4" aria-label="Prints" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Visual Artwork" id="Filter-filter.p.tag-2-filterEle1" data-compare="Filter-filter.p.tag-Visual Artwork" data-count="4" aria-label="Visual Artwork" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inches" id="Filter-filter.v.option.size-1-filterEle1" data-compare="Filter-filter.v.option.size-12*24 inches" data-count="4" aria-label="12*24 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inches" id="Filter-filter.v.option.size-2-filterEle1" data-compare="Filter-filter.v.option.size-12*48 inches" data-count="4" aria-label="12*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inches" id="Filter-filter.v.option.size-3-filterEle1" data-compare="Filter-filter.v.option.size-24*48 inches" data-count="4" aria-label="24*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inches" id="Filter-filter.v.option.size-4-filterEle1" data-compare="Filter-filter.v.option.size-48*96 inches" data-count="4" aria-label="48*96 inches" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_material" class="collapse-filter_v_option_material collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboo" id="Filter-filter.v.option.material-1-filterEle1" data-compare="Filter-filter.v.option.material-Bamboo" data-count="2" aria-label="Bamboo" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-1-filterEle1">Bamboo
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Carved Wood" id="Filter-filter.v.option.material-2-filterEle1" data-compare="Filter-filter.v.option.material-Carved Wood" data-count="1" aria-label="Carved Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle1">Carved Wood
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gilded Frame" id="Filter-filter.v.option.material-3-filterEle1" data-compare="Filter-filter.v.option.material-Gilded Frame" data-count="1" aria-label="Gilded Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle1">Gilded Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Pine Wood" id="Filter-filter.v.option.material-4-filterEle1" data-compare="Filter-filter.v.option.material-Pine Wood" data-count="3" aria-label="Pine Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle1">Pine Wood
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Reclaimed Wood" id="Filter-filter.v.option.material-5-filterEle1" data-compare="Filter-filter.v.option.material-Reclaimed Wood" data-count="3" aria-label="Reclaimed Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle1">Reclaimed Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Solid Wood" id="Filter-filter.v.option.material-6-filterEle1" data-compare="Filter-filter.v.option.material-Solid Wood" data-count="3" aria-label="Solid Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle1">Solid Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Stainless Steel" id="Filter-filter.v.option.material-7-filterEle1" data-compare="Filter-filter.v.option.material-Stainless Steel" data-count="2" aria-label="Stainless Steel" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle1">Stainless Steel
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Textured Frame" id="Filter-filter.v.option.material-8-filterEle1" data-compare="Filter-filter.v.option.material-Textured Frame" data-count="1" aria-label="Textured Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle1">Textured Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
        ...
        <div class="product-check" hidden=""><label for="hidElemenet-filter-filter.v.availability-1" class="visually-hidden">filter.v.availability</label>
              ...
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.p.tag-Prints" data-param="filter.p.tag" data-id="Filter-filter.p.tag-Prints" value="4" style=""><label for="hidElemenet-filter-filter.p.tag-Visual Artwork" class="visually-hidden">filter.p.tag</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.p.tag-Visual Artwork" data-param="filter.p.tag" data-id="Filter-filter.p.tag-Visual Artwork" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-12*24 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-12*24 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*24 inches" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-12*48 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-12*48 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*48 inches" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-24*48 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-24*48 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-24*48 inches" value="4" style=""><label for="hidElemenet-filter-filter.v.option.size-48*96 inches" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.size-48*96 inches" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-48*96 inches" value="4" style=""><label for="hidElemenet-filter-filter.v.option.material-Bamboo" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Bamboo" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bamboo" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Carved Wood" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Carved Wood" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Carved Wood" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Gilded Frame" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Gilded Frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gilded Frame" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Pine Wood" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Pine Wood" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Pine Wood" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Reclaimed Wood" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Reclaimed Wood" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Reclaimed Wood" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Solid Wood" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="3" type="text" id="hidElemenet-filter-filter.v.option.material-Solid Wood" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Solid Wood" value="3" style=""><label for="hidElemenet-filter-filter.v.option.material-Stainless Steel" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Stainless Steel" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Stainless Steel" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Textured Frame" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Textured Frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Textured Frame" value="1" style=""></div>
                ...
                <div style="list-style:none;" class="collapse-filter_v_availability  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle2" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="In stock" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_p_tag  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Prints" id="Filter-filter.p.tag-1-filterEle2" data-compare="Filter-filter.p.tag-Prints" data-count="4" aria-label="Prints" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Visual Artwork" id="Filter-filter.p.tag-2-filterEle2" data-compare="Filter-filter.p.tag-Visual Artwork" data-count="4" aria-label="Visual Artwork" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_size  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inches" id="Filter-filter.v.option.size-1-filterEle2" data-compare="Filter-filter.v.option.size-12*24 inches" data-count="4" aria-label="12*24 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inches" id="Filter-filter.v.option.size-2-filterEle2" data-compare="Filter-filter.v.option.size-12*48 inches" data-count="4" aria-label="12*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inches" id="Filter-filter.v.option.size-3-filterEle2" data-compare="Filter-filter.v.option.size-24*48 inches" data-count="4" aria-label="24*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inches" id="Filter-filter.v.option.size-4-filterEle2" data-compare="Filter-filter.v.option.size-48*96 inches" data-count="4" aria-label="48*96 inches" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_material  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboo" id="Filter-filter.v.option.material-1-filterEle2" data-compare="Filter-filter.v.option.material-Bamboo" data-count="2" aria-label="Bamboo" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-1-filterEle2">Bamboo
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Carved Wood" id="Filter-filter.v.option.material-2-filterEle2" data-compare="Filter-filter.v.option.material-Carved Wood" data-count="1" aria-label="Carved Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle2">Carved Wood
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gilded Frame" id="Filter-filter.v.option.material-3-filterEle2" data-compare="Filter-filter.v.option.material-Gilded Frame" data-count="1" aria-label="Gilded Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle2">Gilded Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Pine Wood" id="Filter-filter.v.option.material-4-filterEle2" data-compare="Filter-filter.v.option.material-Pine Wood" data-count="3" aria-label="Pine Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle2">Pine Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Reclaimed Wood" id="Filter-filter.v.option.material-5-filterEle2" data-compare="Filter-filter.v.option.material-Reclaimed Wood" data-count="3" aria-label="Reclaimed Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle2">Reclaimed Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Solid Wood" id="Filter-filter.v.option.material-6-filterEle2" data-compare="Filter-filter.v.option.material-Solid Wood" data-count="3" aria-label="Solid Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle2">Solid Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Stainless Steel" id="Filter-filter.v.option.material-7-filterEle2" data-compare="Filter-filter.v.option.material-Stainless Steel" data-count="2" aria-label="Stainless Steel" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle2">Stainless Steel
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Textured Frame" id="Filter-filter.v.option.material-8-filterEle2" data-compare="Filter-filter.v.option.material-Textured Frame" data-count="1" aria-label="Textured Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle2">Textured Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle3" data-compare="Filter-filter.v.availability-1" data-count="4" aria-label="In stock" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_p_tag" class="collapse-filter_p_tag collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Prints" id="Filter-filter.p.tag-1-filterEle3" data-compare="Filter-filter.p.tag-Prints" data-count="4" aria-label="Prints" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.p.tag" value="Visual Artwork" id="Filter-filter.p.tag-2-filterEle3" data-compare="Filter-filter.p.tag-Visual Artwork" data-count="4" aria-label="Visual Artwork" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inches" id="Filter-filter.v.option.size-1-filterEle3" data-compare="Filter-filter.v.option.size-12*24 inches" data-count="4" aria-label="12*24 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inches" id="Filter-filter.v.option.size-2-filterEle3" data-compare="Filter-filter.v.option.size-12*48 inches" data-count="4" aria-label="12*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inches" id="Filter-filter.v.option.size-3-filterEle3" data-compare="Filter-filter.v.option.size-24*48 inches" data-count="4" aria-label="24*48 inches" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inches" id="Filter-filter.v.option.size-4-filterEle3" data-compare="Filter-filter.v.option.size-48*96 inches" data-count="4" aria-label="48*96 inches" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_material" class="collapse-filter_v_option_material collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboo" id="Filter-filter.v.option.material-1-filterEle3" data-compare="Filter-filter.v.option.material-Bamboo" data-count="2" aria-label="Bamboo" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-1-filterEle3">Bamboo
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Carved Wood" id="Filter-filter.v.option.material-2-filterEle3" data-compare="Filter-filter.v.option.material-Carved Wood" data-count="1" aria-label="Carved Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-2-filterEle3">Carved Wood
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gilded Frame" id="Filter-filter.v.option.material-3-filterEle3" data-compare="Filter-filter.v.option.material-Gilded Frame" data-count="1" aria-label="Gilded Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-3-filterEle3">Gilded Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Pine Wood" id="Filter-filter.v.option.material-4-filterEle3" data-compare="Filter-filter.v.option.material-Pine Wood" data-count="3" aria-label="Pine Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-4-filterEle3">Pine Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Reclaimed Wood" id="Filter-filter.v.option.material-5-filterEle3" data-compare="Filter-filter.v.option.material-Reclaimed Wood" data-count="3" aria-label="Reclaimed Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-5-filterEle3">Reclaimed Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Solid Wood" id="Filter-filter.v.option.material-6-filterEle3" data-compare="Filter-filter.v.option.material-Solid Wood" data-count="3" aria-label="Solid Wood" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-6-filterEle3">Solid Wood
                              <span class="filter_counts ">(3)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Stainless Steel" id="Filter-filter.v.option.material-7-filterEle3" data-compare="Filter-filter.v.option.material-Stainless Steel" data-count="2" aria-label="Stainless Steel" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle3">Stainless Steel
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Textured Frame" id="Filter-filter.v.option.material-8-filterEle3" data-compare="Filter-filter.v.option.material-Textured Frame" data-count="1" aria-label="Textured Frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle3">Textured Frame
                              <span class="filter_counts ">(1)</span>
                            </label>
