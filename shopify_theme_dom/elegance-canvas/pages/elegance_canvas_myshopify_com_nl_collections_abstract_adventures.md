...
- URL: https://elegance-canvas.myshopify.com/nl/collections/abstract-adventures
- Title: Abstracte Avonturen – Elegance-canvas
- Body classes: gradient
- Custom elements: facet-filters, localization-form, predictive-search, shop-cart-sync
- Headings: Winkelwagen | Je winkelwagen is leeg. | Zoekopdracht | Menu | Abstracte Avonturen | De ballet schoonheid | De genade van de geisha | De Rebelse Muziek | De Dorpsreis | De Witte Dame | Tijdloze reflectie | Alle filters | Join our creative community

## 1. shopify-section-template--19562840981686__main

- Tag: div
- Classes: shopify-section
- Headings: De ballet schoonheid | De genade van de geisha | De Rebelse Muziek | De Dorpsreis | De Witte Dame | Tijdloze reflectie
...
<path d="M11.1966 11.2414C10.8024 9.48613 9.20495 8.16852 7.29868 8.16852C5.39241 8.16852 3.79503 9.48613 3.40077 11.2414C3.33972 11.5131 3.30664 11.7949 3.30664 12.0842C3.30664 12.3735 3.33972 12.6554 3.40077 12.927C3.79492 14.6824 5.39241 16 7.29868 16C9.20495 16 10.8023 14.6823 11.1966 12.927C11.2576 12.6554 11.2907 12.3736 11.2907 12.0842C11.2907 11.7948 11.2576 11.513 11.1966 11.2414ZM7.29868 14.3145C6.04505 14.3145 5.02507 13.314 5.02507 12.0843C5.02507 10.8546 6.04505 9.85412 7.29868 9.85412C8.55231 9.85412 9.57228 10.8546 9.57228 12.0843C9.57228 13.314 8.55231 14.3145 7.29868 14.3145Z"></path>
  ...
  <path d="M0 8H8V10H0V8Z" fill="currentColor"></path>
                    ...
                    <div class="dropdown sorting_duplicate px-0 py-1">
                      <button class="btn border-0 dropdown-toggle px-0 py-2 ps-sm-2 d-flex gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">Alfabetisch: A-Z</button>
      ...
      <div class="clear-filters m-0">
        <div class="filter_results">
          <p class="d-inline-block mb-0 remove_filter rounded-pill d-none">
              ...
              <a href="/nl/collections/abstract-adventures?sort_by=" class="active-filters__clear border-0 btn remove_all rounded-0 text-capitalize text-decoration-underline">Remove all</a>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        ...
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle1" data-compare="Filter-filter.v.availability-1" data-count="6" aria-label="Op voorraad" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        opacity-50">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="0" id="Filter-filter.v.availability-2-filterEle1" data-compare="Filter-filter.v.availability-0" data-count="0" aria-label="Niet op voorraad" disabled="" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle1" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="6" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle1" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="6" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle1" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="6" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle1" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="6" aria-label="48*96 inch" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_material" class="collapse-filter_v_option_material collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Aluminium" id="Filter-filter.v.option.material-1-filterEle1" data-compare="Filter-filter.v.option.material-Aluminium" data-count="2" aria-label="Aluminium" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-2-filterEle1" data-compare="Filter-filter.v.option.material-Bamboe" data-count="1" aria-label="Bamboe" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gelakt frame" id="Filter-filter.v.option.material-4-filterEle1" data-compare="Filter-filter.v.option.material-Gelakt frame" data-count="1" aria-label="Gelakt frame" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-5-filterEle1" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="4" aria-label="Gerecycled hout" style="">
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-6-filterEle1" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="2" aria-label="Gesneden hout" style="">
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-7-filterEle1" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="5" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle1">Grenenhout
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-8-filterEle1" data-compare="Filter-filter.v.option.material-Massief hout" data-count="5" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle1">Massief hout
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-9-filterEle1" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="2" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle1">Roestvrij staal
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-10-filterEle1" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="1" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle1">Verguld frame
                              <span class="filter_counts ">(1)</span>
                            </label>
        ...
        <div class="product-check" hidden=""><label for="hidElemenet-filter-filter.v.availability-1" class="visually-hidden">filter.v.availability</label>
              ...
              <input aria-label="0" type="text" id="hidElemenet-filter-filter.v.availability-0" data-param="filter.v.availability" data-id="Filter-filter.v.availability-0" value="0" style=""><label for="hidElemenet-filter-filter.v.option.size-12*24 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="6" type="text" id="hidElemenet-filter-filter.v.option.size-12*24 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*24 inch" value="6" style=""><label for="hidElemenet-filter-filter.v.option.size-12*48 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="6" type="text" id="hidElemenet-filter-filter.v.option.size-12*48 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-12*48 inch" value="6" style=""><label for="hidElemenet-filter-filter.v.option.size-24*48 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="6" type="text" id="hidElemenet-filter-filter.v.option.size-24*48 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-24*48 inch" value="6" style=""><label for="hidElemenet-filter-filter.v.option.size-48*96 inch" class="visually-hidden">filter.v.option.size</label>
              <input aria-label="6" type="text" id="hidElemenet-filter-filter.v.option.size-48*96 inch" data-param="filter.v.option.size" data-id="Filter-filter.v.option.size-48*96 inch" value="6" style=""><label for="hidElemenet-filter-filter.v.option.material-Aluminium" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Aluminium" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Aluminium" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Bamboe" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Bamboe" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Bamboe" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Frame op maat gemaakt" class="visually-hidden">filter.v.option.material</label>
              ...
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Gelakt frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gelakt frame" value="1" style=""><label for="hidElemenet-filter-filter.v.option.material-Gerecycled hout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="4" type="text" id="hidElemenet-filter-filter.v.option.material-Gerecycled hout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gerecycled hout" value="4" style=""><label for="hidElemenet-filter-filter.v.option.material-Gesneden hout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Gesneden hout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Gesneden hout" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Grenenhout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="5" type="text" id="hidElemenet-filter-filter.v.option.material-Grenenhout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Grenenhout" value="5" style=""><label for="hidElemenet-filter-filter.v.option.material-Massief hout" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="5" type="text" id="hidElemenet-filter-filter.v.option.material-Massief hout" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Massief hout" value="5" style=""><label for="hidElemenet-filter-filter.v.option.material-Roestvrij staal" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="2" type="text" id="hidElemenet-filter-filter.v.option.material-Roestvrij staal" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Roestvrij staal" value="2" style=""><label for="hidElemenet-filter-filter.v.option.material-Verguld frame" class="visually-hidden">filter.v.option.material</label>
              <input aria-label="1" type="text" id="hidElemenet-filter-filter.v.option.material-Verguld frame" data-param="filter.v.option.material" data-id="Filter-filter.v.option.material-Verguld frame" value="1" style=""></div>
                ...
                <div style="list-style:none;" class="collapse-filter_v_availability  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle2" data-compare="Filter-filter.v.availability-1" data-count="6" aria-label="Op voorraad" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        opacity-50">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="0" id="Filter-filter.v.availability-2-filterEle2" data-compare="Filter-filter.v.availability-0" data-count="0" aria-label="Niet op voorraad" disabled="" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_size  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle2" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="6" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle2" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="6" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle2" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="6" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle2" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="6" aria-label="48*96 inch" style="">
                ...
                <div style="list-style:none;" class="collapse-filter_v_option_material  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Aluminium" id="Filter-filter.v.option.material-1-filterEle2" data-compare="Filter-filter.v.option.material-Aluminium" data-count="2" aria-label="Aluminium" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-2-filterEle2" data-compare="Filter-filter.v.option.material-Bamboe" data-count="1" aria-label="Bamboe" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gelakt frame" id="Filter-filter.v.option.material-4-filterEle2" data-compare="Filter-filter.v.option.material-Gelakt frame" data-count="1" aria-label="Gelakt frame" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-5-filterEle2" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="4" aria-label="Gerecycled hout" style="">
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-6-filterEle2" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="2" aria-label="Gesneden hout" style="">
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-7-filterEle2" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="5" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle2">Grenenhout
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-8-filterEle2" data-compare="Filter-filter.v.option.material-Massief hout" data-count="5" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle2">Massief hout
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-9-filterEle2" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="2" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle2">Roestvrij staal
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-10-filterEle2" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="1" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle2">Verguld frame
                              <span class="filter_counts ">(1)</span>
                            </label>
                ...
                <div style="list-style:none;" id="collapse-filter_v_availability" class="collapse-filter_v_availability collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="1" id="Filter-filter.v.availability-1-filterEle3" data-compare="Filter-filter.v.availability-1" data-count="6" aria-label="Op voorraad" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        opacity-50">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.availability" value="0" id="Filter-filter.v.availability-2-filterEle3" data-compare="Filter-filter.v.availability-0" data-count="0" aria-label="Niet op voorraad" disabled="" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_size" class="collapse-filter_v_option_size collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*24 inch" id="Filter-filter.v.option.size-1-filterEle3" data-compare="Filter-filter.v.option.size-12*24 inch" data-count="6" aria-label="12*24 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="12*48 inch" id="Filter-filter.v.option.size-2-filterEle3" data-compare="Filter-filter.v.option.size-12*48 inch" data-count="6" aria-label="12*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="24*48 inch" id="Filter-filter.v.option.size-3-filterEle3" data-compare="Filter-filter.v.option.size-24*48 inch" data-count="6" aria-label="24*48 inch" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.size" value="48*96 inch" id="Filter-filter.v.option.size-4-filterEle3" data-compare="Filter-filter.v.option.size-48*96 inch" data-count="6" aria-label="48*96 inch" style="">
                ...
                <div style="list-style:none;" id="collapse-filter_v_option_material" class="collapse-filter_v_option_material collapse show  extra_button">
                  ...
                  <ul role="listbox" class="
                    ...
                    "><li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Aluminium" id="Filter-filter.v.option.material-1-filterEle3" data-compare="Filter-filter.v.option.material-Aluminium" data-count="2" aria-label="Aluminium" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Bamboe" id="Filter-filter.v.option.material-2-filterEle3" data-compare="Filter-filter.v.option.material-Bamboe" data-count="1" aria-label="Bamboe" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gelakt frame" id="Filter-filter.v.option.material-4-filterEle3" data-compare="Filter-filter.v.option.material-Gelakt frame" data-count="1" aria-label="Gelakt frame" style="">
...
<li role="option" class="d-flex  ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gerecycled hout" id="Filter-filter.v.option.material-5-filterEle3" data-compare="Filter-filter.v.option.material-Gerecycled hout" data-count="4" aria-label="Gerecycled hout" style="">
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Gesneden hout" id="Filter-filter.v.option.material-6-filterEle3" data-compare="Filter-filter.v.option.material-Gesneden hout" data-count="2" aria-label="Gesneden hout" style="">
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Grenenhout" id="Filter-filter.v.option.material-7-filterEle3" data-compare="Filter-filter.v.option.material-Grenenhout" data-count="5" aria-label="Grenenhout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-7-filterEle3">Grenenhout
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Massief hout" id="Filter-filter.v.option.material-8-filterEle3" data-compare="Filter-filter.v.option.material-Massief hout" data-count="5" aria-label="Massief hout" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-8-filterEle3">Massief hout
                              <span class="filter_counts ">(5)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Roestvrij staal" id="Filter-filter.v.option.material-9-filterEle3" data-compare="Filter-filter.v.option.material-Roestvrij staal" data-count="2" aria-label="Roestvrij staal" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-9-filterEle3">Roestvrij staal
                              <span class="filter_counts ">(2)</span>
                            </label>
...
<li role="option" class="d-flex   facts_items hidden ">
                        <div class="d-inline-flex align-items-center gap-2 position-relative
                        ">
                          <input type="checkbox" class="color_swatch flex-shrink-0 me-1 " name="filter.v.option.material" value="Verguld frame" id="Filter-filter.v.option.material-10-filterEle3" data-compare="Filter-filter.v.option.material-Verguld frame" data-count="1" aria-label="Verguld frame" style="">

                          


                            
                            <label for="Filter-filter.v.option.material-10-filterEle3">Verguld frame
                              <span class="filter_counts ">(1)</span>
                            </label>
