...
- URL: https://highlight-theme-main.myshopify.com/de/pages/contact-us
- Title: Kontakte – Highlight Theme
...
<div id="shopify-section-template--15101582639265__main" class="shopify-section shopify-section section-w-margin section-w-mobile-padding"><div class="section-header five-tenths lap--full-width push-left-one-tenth lap--push-left-none">
  <h1 class="section-header__title h1">Kontakte</h1>
</div>
<div class="grid">
  <div class="five-tenths lap--nine-tenths smaller-lap--full-width push-left-one-tenth lap--push-left-none">
    <div class="simple-form"><form method="post" action="/de/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><h2 class="h4" style="margin-bottom:2em">Melde dich</h2>

        <div class="simple-grid"><div class="one-half">
                  <label for="ContactFormName" class="text-size--small">Ihr Name *</label>
                  <input type="text" id="ContactFormName" class="input-full" name="contact[name]" autocapitalize="words" value="" required="" style="">
                </div>
                <div class="one-half">
                  <label for="ContactFormEmail" class="text-size--small">Ihre E-Mail *</label>
...
<div style="display: none;"></div>
<h4>Postanschrift</h4>
<p>Highlight Inc.<br> Attn: Rückgabe/Umtausch<br>123 Great Mill Rd.<br>Washington, WK 12345<br> Vereinigte Staaten von Amerika</p>
<h4>
<strong><br></strong>Eine Frage haben?</h4>
<p>Bitte versuchen Sie, die folgende Antwort zu finden:</p>
<ul>
<li><a href="https://highlight-theme.myshopify.com/pages/returns-exchanges">Allgemeine Geschäftsbedingungen</a></li>
<li><a href="https://highlight-theme.myshopify.com/pages/sizing-fit">Größe &amp; Passform</a></li>
