...
- URL: https://highlight-theme-main.myshopify.com/es/pages/contact-us
- Title: Contactos – Highlight Theme
...
<div id="shopify-section-template--15101582639265__main" class="shopify-section shopify-section section-w-margin section-w-mobile-padding"><div class="section-header five-tenths lap--full-width push-left-one-tenth lap--push-left-none">
  <h1 class="section-header__title h1">Contactos</h1>
</div>
<div class="grid">
  <div class="five-tenths lap--nine-tenths smaller-lap--full-width push-left-one-tenth lap--push-left-none">
    <div class="simple-form"><form method="post" action="/es/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><h2 class="h4" style="margin-bottom:2em">Escríbanos</h2>

        <div class="simple-grid"><div class="one-half">
                  <label for="ContactFormName" class="text-size--small">Su nombre *</label>
                  <input type="text" id="ContactFormName" class="input-full" name="contact[name]" autocapitalize="words" value="" required="" style="">
                </div>
                <div class="one-half">
                  <label for="ContactFormEmail" class="text-size--small">Su correo electrónico *</label>
...
<p>resaltar inc.<br> Atención: Devoluciones/Cambios<br>Calle Great Mill 123<br>Washington, WW 12345<br> EE.UU</p>
<h4>
<strong><br></strong>¿Tengo una pregunta?</h4>
<p>Intente encontrar la respuesta a continuación:</p>
<ul>
<li><a href="https://highlight-theme.myshopify.com/pages/returns-exchanges">Términos y Condiciones</a></li>
<li><a href="https://highlight-theme.myshopify.com/pages/sizing-fit">Talla y ajuste</a></li>
<li><a href="https://highlight-theme.myshopify.com/pages/help-faq">Preguntas más frecuentes</a></li>
</ul>
    </div></div>
