...
- URL: https://highlight-theme-main.myshopify.com/search
...
## 1. shopify-section-template--15101614850209__main
...
```html
<div id="shopify-section-template--15101614850209__main" class="shopify-section section-w-margin section-w-mobile-padding"><link href="//highlight-theme-main.myshopify.com/cdn/shop/t/4/assets/component-search-form.css?v=25183789317793293931681113453" rel="stylesheet" type="text/css" media="all">
<link href="//highlight-theme-main.myshopify.com/cdn/shop/t/4/assets/component-blog-item.css?v=161299119713616711571747066534" rel="stylesheet" type="text/css" media="all">

<div class="section-header five-tenths lap--nine-tenths smaller-lap--full-width push-left-one-tenth lap--push-left-none">
  <h1 class="section-header__title h1">Search</h1><form action="/search" method="get" class="search-form" role="search" autocomplete="off" style="display:flex">

  <input type="search" name="q" value="" placeholder="Enter keyword here" class="input-group-field" aria-label="Enter keyword here" autocomplete="off" data-js-search-input="" style=""><button type="submit" class="button button--solid button--align" style="flex-shrink:0">Search</button></form></div><div id="CollectionProductGrid">
    <div id="main-collection-product-grid" data-id="template--15101614850209__main" data-count=""></div></div>
</div>
```
...
<form method="post" action="/localization" id="localization_form-footer" accept-charset="UTF-8" class="localization-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization" style=""><input type="hidden" name="utf8" value="✓" style=""><input type="hidden" name="_method" value="put" style=""><input type="hidden" name="return_to" value="/search" style=""><localization-form class="localization-form__item">
