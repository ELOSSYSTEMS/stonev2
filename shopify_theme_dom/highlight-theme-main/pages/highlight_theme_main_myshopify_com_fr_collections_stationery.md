...
- URL: https://highlight-theme-main.myshopify.com/fr/collections/stationery
- Title: Papeterie – Highlight Theme
...
<link href="//highlight-theme-main.myshopify.com/cdn/shop/t/4/assets/component-facets.css?v=57495296021939822811717753002" rel="stylesheet" type="text/css" media="all">
  ...
  <div id="collection-filters"><sidebar-drawer id="site-filters-sidebar" class="sidebar sidebar--right" tabindex="-1" role="dialog" aria-modal="true">
        ...
        <div class="sidebar__container">
          ...
          <div class="sidebar__close">
            ...
            <span id="CollectionProductCount" class="collection-product-count sidebar__caption" role="status">4&nbsp;produits
</span>
                    ...
                    <div class="active-facets active-facets-mobile"></div><p class="facets__heading text-size--smaller">Filtre&nbsp;:</p><details id="Filter-filter-v-availability-desktop" class="disclosure-has-popup facets__disclosure js-filter" data-index="1">
                            ...
                            <div class="facets__display text-size--smaller">
                              <div class="facets__header">
                                ...
                                <facet-remove>
                                  <a href="/fr/collections/stationery" class="facets__reset link underlined-link js-facet-remove" role="button">Réinitialiser</a>
                                </facet-remove>
                              </div><ul class="facets__list list-unstyled swatch-list--text swatch-list--text-onecolumn" role="list"><li class="list-menu__item facets__item   ">

      <label for="desktop-Filter-disponibilite-1" class="facet-checkbox">
        
        <input type="checkbox" class="styled-checkbox" name="filter.v.availability" value="1" id="desktop-Filter-disponibilite-1" style=""><span>En stock (4)</span>
      ...
      <label for="desktop-Filter-disponibilite-2" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.v.availability" value="0" id="desktop-Filter-disponibilite-2" style=""><span>En rupture de stock (1)</span>
                            ...
                            <div class="facets__display text-size--smaller">
                              ...
                              <div class="facets__header"><span class="facets__selected">Le prix le plus élevé est de $49.00</span>
                                <facet-remove>
                                  <a href="/fr/collections/stationery" class="facets__reset link underlined-link js-facet-remove" role="button">Réinitialiser</a>
                                </facet-remove>
  ...
  <div class="field">
    ...
    <input class="field__input" name="filter.v.price.gte" id="desktop-Filter-Prix-GTE" type="number" inputmode="numeric" min="0" max="49" placeholder="0" style="">
  </div>
  ...
  <div class="field">
    <span class="field__currency">$</span>
    <input class="field__input" name="filter.v.price.lte" id="desktop-Filter-Prix-LTE" type="number" inputmode="numeric" min="0" max="49" placeholder="49" style="">
  </div>
</price-range>
...
<div id="desktop-facets-price-range-slider" data-js-price-range-slider="" class="range-slider"><input type="range" min="0" max="49" step="1" value="0" disabled="" style=""><input type="range" min="0" max="49" step="1" value="49" disabled="" style=""><div role="slider" class="range-slider__thumb" data-lower="" aria-valuemin="0" aria-valuemax="49" aria-valuenow="0" aria-valuetext="0" aria-disabled="false" tabindex="0" style="left: calc(0% + 8px);"></div><div role="slider" class="range-slider__thumb" data-upper="" aria-valuemin="0" aria-valuemax="49" aria-valuenow="49" aria-valuetext="49" aria-disabled="false" tabindex="0" style="left: calc(100% - 8px);"></div><div class="range-slider__range"></div></div></div>
      ...
      <label for="desktop-Filter-type-de-produit-1" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.p.product_type" value="camera cover" id="desktop-Filter-type-de-produit-1" style=""><span>camera cover (1)</span>
      ...
      <label for="desktop-Filter-type-de-produit-2" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.p.product_type" value="Scratch card" id="desktop-Filter-type-de-produit-2" style=""><span>Scratch card (1)</span>
      ...
      <label for="desktop-Filter-type-de-produit-3" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.p.product_type" value="wall sticker" id="desktop-Filter-type-de-produit-3" style=""><span>wall sticker (1)</span>
      ...
      <label for="desktop-Filter-type-de-produit-4" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.p.product_type" value="wrapping paper" id="desktop-Filter-type-de-produit-4" style=""><span>wrapping paper (1)</span>
      ...
      <label for="desktop-Filter-size-1" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.v.option.size" value="Petit" id="desktop-Filter-size-1" style=""><span>Petit (1)</span>
      ...
      <label for="desktop-Filter-size-2" class="facet-checkbox">
        ...
        <input type="checkbox" class="styled-checkbox" name="filter.v.option.size" value="Gros" id="desktop-Filter-size-2" style=""><span>Gros (1)</span>
...
</div><div class="product-item product-item--1 four-tenths push-left-one-tenth push-top-one-tenth lap--four-plus-tenths lap--push-top-one-tenth palm--five-plus-tenths palm--push-top-two-tenths palm--push-left-one-tenth product-item--zoom" data-js-product-item=""><a class="product-item__link" href="/fr/collections/stationery/products/wall-sticker-xmas-tree">
...
</div><div class="product-item product-item--3 three-tenths push-left-two-tenths  lap--six-plus-tenths lap--push-left-one-tenth lap--push-top-none palm--five-plus-tenths palm--push-top-none palm--push-left-one-tenth product-item--zoom" data-js-product-item=""><a class="product-item__link" href="/fr/collections/stationery/products/camera-cover">
