...
- URL: https://highlight-theme-main.myshopify.com/pages/contact-us
- Title: Contacts – Highlight Theme
...
- Headings: Contacts | Drop us a line
...
<div id="shopify-section-template--15101582639265__main" class="shopify-section shopify-section section-w-margin section-w-mobile-padding"><div class="section-header five-tenths lap--full-width push-left-one-tenth lap--push-left-none">
  <h1 class="section-header__title h1">Contacts</h1>
</div>
<div class="grid">
  <div class="five-tenths lap--nine-tenths smaller-lap--full-width push-left-one-tenth lap--push-left-none">
    <div class="simple-form"><form method="post" action="/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><h2 class="h4" style="margin-bottom:2em">Drop us a line</h2>
        ...
        <div class="simple-grid"><div class="one-half">
                ...
                </div><div class="one-whole"><label for="field1628539090bcf511f6-1" class="text-size--small">Message * </label><textarea rows="10" id="field1628539090bcf511f6-1" name="contact[message]" autocorrect="off" autocapitalize="off" autocomplete="off" required="" style=""></textarea></div><div class="one-whole">
...
<p>Highlight Inc.<br> Attn: Returns/Exchanges<br>123&nbsp;Great Mill Rd.<br>Washington, WW 12345<br> USA</p>
<h4>
<strong><br></strong>Have a question?</h4>
<p>Please try finding the answer below:</p>
<ul>
<li><a href="https://highlight-theme.myshopify.com/pages/returns-exchanges">Tems &amp; Conditions</a></li>
<li><a href="https://highlight-theme.myshopify.com/pages/sizing-fit">Sizing &amp; Fit</a></li>
...
<form method="post" action="/localization" id="localization_form-footer" accept-charset="UTF-8" class="localization-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization" style=""><input type="hidden" name="utf8" value="✓" style=""><input type="hidden" name="_method" value="put" style=""><input type="hidden" name="return_to" value="/pages/contact-us" style=""><localization-form class="localization-form__item">
