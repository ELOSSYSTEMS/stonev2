...
- URL: https://highlight-theme-main.myshopify.com/it/pages/contact-us
- Title: Contatti – Highlight Theme
...
- Headings: Contatti | Mandaci una riga

## 1. shopify-section-template--15101582639265__main
...
```html
<div id="shopify-section-template--15101582639265__main" class="shopify-section shopify-section section-w-margin section-w-mobile-padding"><div class="section-header five-tenths lap--full-width push-left-one-tenth lap--push-left-none">
  <h1 class="section-header__title h1">Contatti</h1>
</div>
<div class="grid">
  <div class="five-tenths lap--nine-tenths smaller-lap--full-width push-left-one-tenth lap--push-left-none">
    <div class="simple-form"><form method="post" action="/it/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><h2 class="h4" style="margin-bottom:2em">Mandaci una riga</h2>

        <div class="simple-grid"><div class="one-half">
                  <label for="ContactFormName" class="text-size--small">Il suo nome *</label>
                  <input type="text" id="ContactFormName" class="input-full" name="contact[name]" autocapitalize="words" value="" required="" style="">
                </div>
                <div class="one-half">
                  <label for="ContactFormEmail" class="text-size--small">La sua email *</label>
                  <input type="email" id="ContactFormEmail" class="input-full" name="contact[email]" autocorrect="off" autocapitalize="off" value="" required="" style="">
                </div><div class="one-whole"><label for="field1628539090bcf511f6-1" class="text-size--small">Messaggio * </label><textarea rows="10" id="field1628539090bcf511f6-1" name="contact[messaggio]" autocorrect="off" autocapitalize="off" autocomplete="off" required="" style=""></textarea></div><div class="one-whole">
                  <span class="info text-size--small">* Sì, questo è un campo obbligatorio</span>
                  <button type="submit" class="button button--solid button--wide button--align" aria-label="Invio del messaggio"><svg aria-hidden="true" focusable="false" role="presentation" width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M0.957243 14.6996L31.9091 0.965088L26.1462 28.6264L18.7847 24.5487L14.7692 30.635L14.3489 22.0916L28.6547 4.2271L11.2803 20.3894L0.957243 14.6996Z" fill="white"></path></svg></button>
                </div></div></form></div>
  </div><div class="four-tenths lap--full-width push-left-one-tenth lap--push-left-none lap--push-top-one-tenth rte">
      <div style="display: none;"></div>
<div style="display: none;"></div>
<div style="display: none;"></div>
<h4>Indirizzo di posta</h4>
<p>Evidenzia Inc.<br> Attn: Resi/Cambi<br>123&nbsp;Great Mill Road.<br>Washington, WW 12345<br> USA</p>
<h4>
<strong><br></strong>Hai una domanda?</h4>
<p>Si prega di provare a trovare la risposta di seguito:</p>
<ul>
<li><a href="https://highlight-theme.myshopify.com/pages/returns-exchanges">Termini e condizioni</a></li>
<li><a href="https://highlight-theme.myshopify.com/pages/sizing-fit">Taglie e vestibilità</a></li>
<li><a href="https://highlight-theme.myshopify.com/pages/help-faq">FAQ</a></li>
</ul>
    </div></div>
...
<form method="post" action="/it/localization" id="localization_form-footer" accept-charset="UTF-8" class="localization-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization" style=""><input type="hidden" name="utf8" value="✓" style=""><input type="hidden" name="_method" value="put" style=""><input type="hidden" name="return_to" value="/it/pages/contact-us" style=""><localization-form class="localization-form__item">
