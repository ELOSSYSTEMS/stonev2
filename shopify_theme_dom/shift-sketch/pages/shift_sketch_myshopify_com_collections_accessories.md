...
- URL: https://shift-sketch.myshopify.com/collections/accessories
- Title: Accessories – Shift Sketch
...
- Headings: Collection: Accessories | Craft Desk Clip | Craft Pin Badge | Shaped Clips Set | Craft Logo Sticker | Craft Oversize Tote | Shop | Shop | Explore | Explore | Legal | Legal | Follow us | Join our Newsletter

## 1. shopify-section-template--27266934243703__product-grid

- Tag: section
- Classes: shopify-section collection-grid-section
- Headings: Collection: Accessories | Craft Desk Clip | Craft Pin Badge | Shaped Clips Set | Craft Logo Sticker | Craft Oversize Tote
...
<div class="collection-hero__slider">
            <div class="collection-hero__slider-wrapper swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
              <div class="swiper-wrapper" id="swiper-wrapper-14ac2caec6f102a1f" aria-live="polite">
              ...
              <div class="collection-hero__navigation-wrapper no-js-hidden">
                <button class="collection-hero__navigation-button-prev swiper-button-prev focus-inset swiper-button-disabled swiper-button-lock" disabled="" tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-14ac2caec6f102a1f" aria-disabled="true">
  ...
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
                ...
                <button class="collection-hero__navigation-button-next swiper-button-next focus-inset swiper-button-disabled swiper-button-lock" disabled="" tabindex="-1" aria-label="Next slide" aria-controls="swiper-wrapper-14ac2caec6f102a1f" aria-disabled="true">
  ...
  <rect x="11" y="5" width="5" height="10" fill="currentColor"></rect>
            ...
            <div class="facets__product-count" role="status">
              <div class="facets__product-count-text body-normal">
                <span class="body-normal" id="ProductCount">5 items
</span>
              </div>
            </div>
...
5
                              ...
                              <li class="facets__item highlight--border">
                                ...
                                <label for="Filter-Availability-2" class="facet-checkbox focus-inset facet-checkbox--disabled" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
1
                              ...
                              <li class="facets__item highlight--border">
                                <input type="checkbox" class="focus-inset" name="filter.p.t.category" value="os-4-4" id="Filter-Category-2" style="">
...
1
                              ...
                              <li class="facets__item highlight--border">
                                <input type="checkbox" class="focus-inset" name="filter.p.t.category" value="os-4-8-2" id="Filter-Category-3" style="">
...
1
                              ...
                              <li class="facets__item highlight--border">
                                <input type="checkbox" class="focus-inset" name="filter.p.t.category" value="os-4-9-14" id="Filter-Category-4" style="">
...
1
                              ...
                              <li class="facets__item highlight--border">
                                <input type="checkbox" class="focus-inset" name="filter.p.t.category" value="lb-13" id="Filter-Category-5" style="">
...
1
  ...
  <a href="/collections/accessories" aria-label="Clear filters" class="button button--custom active-facets__button-remove focus-inset " role="button">
  ...
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-f1e8bb528b088fe0" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                ...
                <div class="swiper-slide" data-media-id="67657668755831" role="group" aria-label="4 / 6" style="width: 326px; margin-right: 2px;">
                  <img src="//shift-sketch.myshopify.com/cdn/shop/files/05-accessories-hover-01.jpg?v=1763982258&amp;width=880" alt="Craft Desk Clip" srcset="//shift-sketch.myshopify.com/cdn/shop/files/05-accessories-hover-01.jpg?v=1763982258&amp;width=360 360w, //shift-sketch.myshopify.com/cdn/shop/files/05-accessories-hover-01.jpg?v=1763982258&amp;width=535 535w, //shift-sketch.myshopify.com/cdn/shop/files/05-accessories-hover-01.jpg?v=1763982258&amp;width=720 720w" width="880" height="1168" loading="eager" class="motion-reduce media" sizes="(min-width: 1200px) calc(1.03 * (100vw / 4)),(min-width: 990px) calc(1.03 * (100vw / 3)),(min-width: 576px) calc(1.03 * (100vw / 2)),calc(1.03 * 100vw)" style="object-fit: cover;">
                </div>
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f1e8bb528b088fe0" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-f1e8bb528b088fe0" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<input type="radio" id="template--27266934243703__product-grid-1-0-15256451055991-1" name="Color-template--27266934243703__product-grid-15256451055991-1" value="Blue" data-variant-id="56233978986871" form="product-form-template--27266934243703__product-grid" checked="" tabindex="-1" aria-label="Blue" data-option-value-id="10833288561015" style="">
    
<label for="template--27266934243703__product-grid-1-0-15256451055991-1" class="color-swatch" style="--swatch-color: rgb(0 91 211);" title="Blue" tabindex="0" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();document.getElementById(this.getAttribute('for')).click();}" data-unavailable-color-label="N/A">
...
<input type="radio" id="template--27266934243703__product-grid-1-1-15256451055991-1" name="Color-template--27266934243703__product-grid-15256451055991-1" value="Green" data-variant-id="56233979019639" form="product-form-template--27266934243703__product-grid" tabindex="-1" aria-label="Green" data-option-value-id="10833288593783" style="">
    
<label for="template--27266934243703__product-grid-1-1-15256451055991-1" class="color-swatch" style="--swatch-color: rgb(5 170 61);" title="Green" tabindex="0" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();document.getElementById(this.getAttribute('for')).click();}" data-unavailable-color-label="N/A">
...
<input type="radio" id="template--27266934243703__product-grid-1-2-15256451055991-1" name="Color-template--27266934243703__product-grid-15256451055991-1" value="Red" data-variant-id="56233979052407" form="product-form-template--27266934243703__product-grid" tabindex="-1" aria-label="Red" data-option-value-id="10833288626551" style="">
    
<label for="template--27266934243703__product-grid-1-2-15256451055991-1" class="color-swatch" style="--swatch-color: rgb(246 31 31);" title="Red" tabindex="0" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();document.getElementById(this.getAttribute('for')).click();}" data-unavailable-color-label="N/A">
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="craft-pin-badge" data-product-id="15256448172407" data-image-linked="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 6">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-dd21fc7e10a6c85ff" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-dd21fc7e10a6c85ff" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-dd21fc7e10a6c85ff" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="shaped-clips-set" data-product-id="15256436310391" data-image-linked="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 4">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-e3066316dc3cf15d" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-e3066316dc3cf15d" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-e3066316dc3cf15d" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
Sale
        ...
        <modal-opener data-modal="#QuickView-15256436310391">
          <button class="product-card__button button button--primary focus-inset" aria-haspopup="dialog" data-product-url="/products/shaped-clips-set" aria-label="Quick view">
            <div class="button__content">
              <span class="product-card__quickview-text button__label" data-label="Quick view">Quick view</span>
              <span class="product-card__mobile-icon button__icon">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="product-card__information">
    <div class="product-card__information-top"><h2 class="product-card__title">
        <a class="focus-inset" href="/products/shaped-clips-set" aria-label="Shaped Clips Set">Shaped Clips Set</a>
      </h2>
...
</div><a href="/products/shaped-clips-set" class="product-card__link-overlay focus-inset" aria-label="Shaped Clips Set Product link"></a></product-card>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="craft-logo-sticker" data-product-id="15256435163511" data-image-linked="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 5">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-e3707ce62c8b96e7" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-e3707ce62c8b96e7" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-e3707ce62c8b96e7" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="craft-oversize-tote" data-product-id="15256434114935" data-image-linked="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 4">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-5a1a3b8c01cf4822" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-5a1a3b8c01cf4822" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-5a1a3b8c01cf4822" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
