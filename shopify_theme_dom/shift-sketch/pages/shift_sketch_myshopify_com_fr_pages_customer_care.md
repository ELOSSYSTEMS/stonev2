...
- URL: https://shift-sketch.myshopify.com/fr/pages/customer-care
- Title: Service client – Shift Sketch
...
@media screen and (min-width: 1440px) { #shopify-section-template--27266934014327__content_tabs {
  ...
  <h6> N'hésitez pas à nous contacter à tout moment.</h6> <p>Veuillez remplir le formulaire ci-dessous pour nous faire part de vos questions ou commentaires. Nous accordons une grande importance à vos retours et nous nous efforçons de vous répondre dans les 24 heures. Votre satisfaction est notre priorité.</p>
<p> <strong>Nous serions ravis d'avoir de vos nouvelles.</strong></p>
<p> Vous avez une question, un commentaire ou vous voulez simplement nous dire bonjour&nbsp;? Remplissez le formulaire et nous vous répondrons dans les plus brefs délais.</p>
...
<div id="shopify-block-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd" class="shopify-block tab-contact-form-block"><div class="content-tabs__tab-contact-form">
  <div class="content-tabs__tab-contact-form__wrapper"><form method="post" action="/fr/contact#ContactFormTab-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd" id="ContactFormTab-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd" accept-charset="UTF-8" class="contact-form__form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><div class="field field__name">
        <input class="field__input focus-inset" autocomplete="name" type="text" id="ContactFormTab-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd-name" dir="ltr" name="contact[Nom]" value="" placeholder="Nom" style="">
        <label class="field__label body-small" for="ContactFormTab-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd-name">Nom</label>
      </div>
      ...
      <div class="field">
        <input type="tel" id="ContactFormTab-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd-phone" dir="ltr" class="field__input" autocomplete="tel" name="contact[Numéro de téléphone]" pattern="[0-9\-]*" value="" placeholder="Numéro de téléphone" style="">
        <label class="field__label body-small" for="ContactFormTab-ATXozdGJsaVpGOEVQb__contact_form_fJKLkd-phone">Numéro de téléphone</label>
      </div>
