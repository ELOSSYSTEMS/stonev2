...
- URL: https://shift-sketch.myshopify.com/pages/data-sharing-opt-out
- Title: Your Privacy Choices – Shift Sketch
...
- Headings: Your Privacy Choices | Shop | Shop | Explore | Explore | Legal | Legal | Follow us | Join our Newsletter
...
<div class="page-section-wrapper container align-left">
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="page-header__inner-title h5">Your Privacy Choices</h1>
    </div>
  </div><div class="rte">
  ...
  <div id="pc--opt-out-form-container" style="display: none;">
    ...
    <form action="/dns_opt_out" class="pc--opt-out-form" method="POST" id="pc--opt-out-form" accept-charset="UTF-8">
      ...
      <div class="pc--show-email-field">
        ...
        <div id="hcaptcha" class="h-captcha" data-sitekey="b2f59229-c8ff-461c-8062-5d9a4408eb20" data-callback="submitOptOutForm" data-size="invisible"><iframe aria-hidden="true" data-hcaptcha-widget-id="0a0tkig1mwcl" data-hcaptcha-response="" src="https://newassets.hcaptcha.com/captcha/v1/9abe19f0c4a8a3dfa7147f989a6f693ecec2228b/static/hcaptcha.html#frame=checkbox-invisible" style="display: none;"></iframe><textarea id="g-recaptcha-response-0a0tkig1mwcl" name="g-recaptcha-response" style="display: none;"></textarea><textarea id="h-captcha-response-0a0tkig1mwcl" name="h-captcha-response" style="display: none;"></textarea></div>
      </div>
