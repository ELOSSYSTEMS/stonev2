...
- URL: https://shift-sketch.myshopify.com/fr/pages/steps
- Title: Mesures – Shift Sketch
...
- Headings: Mesures | « De la conception à la création. Chaque détail est pris en compte. » | Boutique | Boutique | Explorer | Explorer | Légal | Légal | Suivez-nous | Abonnez-vous à notre newsletter
...
<div class="page-section-wrapper container align-left">
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="page-header__inner-title h5">Mesures</h1>
    </div>
  </div></div>
    ...
    <div class="steps__wrapper">
      ...
      <div class="steps__box"><div class="steps__blocks">
        ...
        <div class="steps__image-block">
            ...
            <h4 class="steps-side-heading parallax-text vertical-text" data-parallax="400" style="transform: translateY(60px);">
              Quartier général
            </h4>
