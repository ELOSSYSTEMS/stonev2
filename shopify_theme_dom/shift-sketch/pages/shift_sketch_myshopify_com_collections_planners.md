...
- URL: https://shift-sketch.myshopify.com/collections/planners
- Title: Planners – Shift Sketch
...
- Headings: Collection: Planners | Day-to-Day Planner | Essential Grid Planner | Schedule Master Planner | Productivity Planner Pro | Weekly Layout Planner | Daily Structure Planner | Shop | Shop | Explore | Explore | Legal | Legal | Follow us | Join our Newsletter

## 1. shopify-section-template--27266934243703__product-grid

- Tag: section
- Classes: shopify-section collection-grid-section
- Headings: Collection: Planners | Day-to-Day Planner | Essential Grid Planner | Schedule Master Planner | Productivity Planner Pro | Weekly Layout Planner
      ...
      <div class="collection-hero__content">
        <div class="collection-hero__text">
          <h1 class="collection-hero__title h3">
            <span class="visually-hidden">Collection: </span>Planners</h1></div>
...
<div class="collection-hero__slider">
            <div class="collection-hero__slider-wrapper swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
              <div class="swiper-wrapper" id="swiper-wrapper-896326571135101c7" aria-live="polite">
              ...
              <div class="collection-hero__navigation-wrapper no-js-hidden">
                <button class="collection-hero__navigation-button-prev swiper-button-prev focus-inset swiper-button-disabled swiper-button-lock" disabled="" tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-896326571135101c7" aria-disabled="true">
  ...
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
                ...
                <button class="collection-hero__navigation-button-next swiper-button-next focus-inset swiper-button-disabled swiper-button-lock" disabled="" tabindex="-1" aria-label="Next slide" aria-controls="swiper-wrapper-896326571135101c7" aria-disabled="true">
                            ...
                            <price-range class="facets__price">
                              ...
                              <div class="facets__price-wrapper">
                                ...
                                <div class="field" data-prefix="From" data-suffix="$">
                                  ...
                                  <input dir="ltr" class="field__input" name="filter.v.price.gte" id="Filter-Price-GTE" value="0" type="number" placeholder="0" min="0" max="15" step="1" autocomplete="off" style="">
                                </div>
                                
                                <div class="field" data-prefix="To" data-suffix="$">
                                  
                                  <label class="field__label body-normal" for="Filter-Price-LTE">To</label>
                                  <input dir="ltr" class="field__input" name="filter.v.price.lte" id="Filter-Price-LTE" value="15" type="number" min="0" max="15" step="1" placeholder="15" style="">
                                </div>
                              </div>
                              <div class="facets__range" style="--range-min: 0.0%; --range-max: 100.0%">
                                <label class="visually-hidden" for="Filter-Price-Min">From</label>
                                <input dir="ltr" type="range" value="0" min="0" max="15" step="1" class="field__range" id="Filter-Price-Min" style="">
                                <label class="visually-hidden" for="Filter-Price-Max">To</label>
                                <input dir="ltr" type="range" value="15" min="0" max="15" step="1" class="field__range" id="Filter-Price-Max" style="z-index: 0;">
                              </div>
                            </price-range>
                          </div>
                        </details>
                        ...
                        <div id="Facet-5-template--27266934243703__product-grid" class="facets__display">
                          <ul class="
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(0 91 211);">
                                <input type="checkbox" class="focus-inset" name="filter.v.t.shopify.color-pattern" value="gid://shopify/TaxonomyValue/2" id="Filter-Color-1" style="">
                                <label for="Filter-Color-1" class="facet-checkbox focus-inset facet-checkbox--color" title="Blue" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
Blue
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(128 128 128);">
                                <input type="checkbox" class="focus-inset" name="filter.v.t.shopify.color-pattern" value="gid://shopify/TaxonomyValue/8" id="Filter-Color-2" style="">
                                <label for="Filter-Color-2" class="facet-checkbox focus-inset facet-checkbox--color" title="Gray" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
Gray
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(5 170 61);">
                                <input type="checkbox" class="focus-inset" name="filter.v.t.shopify.color-pattern" value="gid://shopify/TaxonomyValue/9" id="Filter-Color-3" style="">
                                <label for="Filter-Color-3" class="facet-checkbox focus-inset facet-checkbox--color" title="Green" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
Green
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(255 192 203);">
                                ...
                                <label for="Filter-Color-4" class="facet-checkbox focus-inset facet-checkbox--color" title="Pink" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
Pink
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(165 77 207);">
                                <input type="checkbox" class="focus-inset" name="filter.v.t.shopify.color-pattern" value="gid://shopify/TaxonomyValue/12" id="Filter-Color-5" style="">
                                <label for="Filter-Color-5" class="facet-checkbox focus-inset facet-checkbox--color" title="Purple" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
Purple
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(246 31 31);">
                                <input type="checkbox" class="focus-inset" name="filter.v.t.shopify.color-pattern" value="gid://shopify/TaxonomyValue/13" id="Filter-Color-6" style="">
                                <label for="Filter-Color-6" class="facet-checkbox focus-inset facet-checkbox--color" title="Red" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
Red
                              ...
                              <li class="facets__item facets__item--color highlight--border" style="--border-radius: px; --swatch-color: rgb(255 255 255);">
                                <input type="checkbox" class="focus-inset" name="filter.v.t.shopify.color-pattern" value="gid://shopify/TaxonomyValue/3" id="Filter-Color-7" style="">
                                <label for="Filter-Color-7" class="facet-checkbox focus-inset facet-checkbox--color" title="White" tabindex="0" role="checkbox" aria-checked="false" data-accessible-init="true"><span class="facet-checkbox__checkbox"></span><span class="facet-checkbox__label body-small">
...
White
  ...
  <a href="/collections/planners" aria-label="Clear filters" class="button button--custom active-facets__button-remove focus-inset " role="button">
  ...
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-f40a42eb3ea397b7" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f40a42eb3ea397b7" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-f40a42eb3ea397b7" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="essential-grid-planner" data-product-id="15252881572215" data-image-linked="true" data-card-color-swatches="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 5">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-61810d0bf11a4d10b9" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-61810d0bf11a4d10b9" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-61810d0bf11a4d10b9" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="schedule-master-planner" data-product-id="15252879835511" data-image-linked="true" data-card-color-swatches="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 5">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-9bfa5cdb28835019" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-9bfa5cdb28835019" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-9bfa5cdb28835019" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<label for="template--27266934243703__product-grid-3-1-15252879835511-3" class="color-swatch" style="--swatch-color: rgb(255 255 255);" title="White" tabindex="0" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();document.getElementById(this.getAttribute('for')).click();}" data-unavailable-color-label="N/A">
    ...
    <span class="hidden" data-product-card-options="" data-product-title="Schedule Master Planner" data-product-columns="4" data-product-columns-mobile="1" data-product-ratio="0.76" data-product-fit="cover" data-product-has-price-varies="false"></span><a href="/products/schedule-master-planner" class="product-card__link-overlay focus-inset" aria-label="Schedule Master Planner Product link"></a></product-card>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="productivity-planner-pro" data-product-id="15252878721399" data-image-linked="true" data-card-color-swatches="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 5">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-4f6442500f80bde7" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-4f6442500f80bde7" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-4f6442500f80bde7" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<div class="product-card__badges body-normal"></div>
        ...
        <modal-opener data-modal="#QuickView-15252878721399">
          <button class="product-card__button button button--primary focus-inset" aria-haspopup="dialog" data-product-url="/products/productivity-planner-pro" aria-label="Quick view">
            <div class="button__content">
              <span class="product-card__quickview-text button__label" data-label="Quick view">Quick view</span>
              <span class="product-card__mobile-icon button__icon">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<label for="template--27266934243703__product-grid-3-3-15252878721399-4" class="color-swatch" style="--swatch-color: rgb(128 128 128);" title="Gray" tabindex="0" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();document.getElementById(this.getAttribute('for')).click();}" data-unavailable-color-label="N/A">
    ...
    <span class="hidden" data-product-card-options="" data-product-title="Productivity Planner Pro" data-product-columns="4" data-product-columns-mobile="1" data-product-ratio="0.76" data-product-fit="cover" data-product-has-price-varies="false"></span><a href="/products/productivity-planner-pro" class="product-card__link-overlay focus-inset" aria-label="Productivity Planner Pro Product link"></a></product-card>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="weekly-layout-planner" data-product-id="15252593115511" data-image-linked="true" data-card-color-swatches="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 5">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-db2221c3e2b9a607" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-db2221c3e2b9a607" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-db2221c3e2b9a607" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
...
<label for="template--27266934243703__product-grid-3-2-15252593115511-5" class="color-swatch" style="--swatch-color: rgb(5 170 61);" title="Green" tabindex="0" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();document.getElementById(this.getAttribute('for')).click();}" data-unavailable-color-label="N/A">
    ...
    <span class="hidden" data-product-card-options="" data-product-title="Weekly Layout Planner" data-product-columns="4" data-product-columns-mobile="1" data-product-ratio="0.76" data-product-fit="cover" data-product-has-price-varies="false"></span><a href="/products/weekly-layout-planner" class="product-card__link-overlay focus-inset" aria-label="Weekly Layout Planner Product link"></a></product-card>
...
<product-card class="product-card product-card--mobile-1 product-card_image-linked" data-product="daily-structure-planner" data-product-id="15252589969783" data-image-linked="true" data-card-color-swatches="true" tabindex="0" style="--card-padding-bottom: 131.7%; --slide-count: 5">
  <div class="product-card__inner">
    <div class="product-card__media">
          ...
          <div class="swiper-container product-card-js global-variant-js-media-list slider_started swiper-initialized swiper-horizontal swiper-backface-hidden" data-loop="false">
            <div class="swiper-wrapper" id="swiper-wrapper-73109dffc23f23858" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <div class="product-button-group">
              <div class="product-slider-button-prev">
                <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-73109dffc23f23858" aria-disabled="true"><svg class="icon icon-arrow-slider-left" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M14 2L6 10L14 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
              ...
              <div class="product-slider-button-next">
                <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-73109dffc23f23858" aria-disabled="false"><svg class="icon icon-arrow-slider-right" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 2L14 10L6 18" stroke="currentColor"></path>
</svg>
</div>
              </div>
