...
- URL: https://shift-sketch.myshopify.com/fr/pages/social-media-collage
- Title: collage des médias sociaux – Shift Sketch
...
- Headings: collage des médias sociaux | Boutique | Boutique | Explorer | Explorer | Légal | Légal | Suivez-nous | Abonnez-vous à notre newsletter

## 1. shopify-section-template--28054349971831__page_info

- Tag: section
- Classes: shopify-section page-section
- Headings: collage des médias sociaux
...
<div class="page-section-wrapper container align-left">
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="page-header__inner-title h5">collage des médias sociaux</h1>
    </div>
  </div></div>
...
<style data-shopify="">#shopify-section-template--28054349971831__social_media_QqMPiA {
       --per-row: 4;
        ...
        <div class="social-media-slider"><div class="social-media-content__info h5">
              <p class="social-media-content__info-name parallax-text vertical-text" data-parallax="250" style="transform: translateY(76px);">
                Suivez-nous ici
              </p>
  ...
  <a href="https://www.instagram.com/shopify" aria-label="@nom d'utilisateur" class="button button--tertiary social-media-content__button h5 focus-inset featured_button animate-in" target="_blank">
  ...
  <path d="M1.56577 13.9997H29.4342M29.4342 13.9997L17.2415 26.1924M29.4342 13.9997L17.2415 1.8069" stroke="currentColor" stroke-width="2" stroke-linecap="square"></path>
      ...
      <span class="button__label">@nom d'utilisateur</span>
    </span>
  </a>
</div>
        </div>
