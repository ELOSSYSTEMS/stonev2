...
- URL: https://shift-sketch.myshopify.com/it/pages/multicolumn
- Title: Multicolonna – Shift Sketch
...
- Headings: Multicolonna | Titolo della funzionalità qui | Titolo della funzionalità qui | Titolo della funzionalità qui | Negozio | Negozio | Esplorare | Esplorare | Legal | Legal | Seguici | Iscriviti alla nostra newsletter

## 1. shopify-section-template--28054349906295__page_info

- Tag: section
- Classes: shopify-section page-section
- Headings: Multicolonna
...
<div class="page-section-wrapper container align-left">
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="page-header__inner-title h5">Multicolonna</h1>
    </div>
  </div></div>
...
- Headings: Titolo della funzionalità qui | Titolo della funzionalità qui | Titolo della funzionalità qui
...
<div class="multicolumn-card__content"><h3 class="multicolumn-card__heading body-large ">
                  <span class="richtext-link-inside">Titolo della funzionalità qui</span>
                </h3><p class="multicolumn-card__text richtext-link-inside body-normal">Descrivi brevemente la colonna</p></div></div>
