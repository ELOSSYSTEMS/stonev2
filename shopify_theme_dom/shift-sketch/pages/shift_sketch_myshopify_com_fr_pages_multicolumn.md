...
- URL: https://shift-sketch.myshopify.com/fr/pages/multicolumn
- Title: Multicolonne – Shift Sketch
...
- Headings: Multicolonne | Titre de l'article ici | Titre de l'article ici | Titre de l'article ici | Boutique | Boutique | Explorer | Explorer | Légal | Légal | Suivez-nous | Abonnez-vous à notre newsletter

## 1. shopify-section-template--28054349906295__page_info

- Tag: section
- Classes: shopify-section page-section
- Headings: Multicolonne
...
<div class="page-section-wrapper container align-left">
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="page-header__inner-title h5">Multicolonne</h1>
    </div>
  </div></div>
...
<div class="multicolumn-card__content"><h3 class="multicolumn-card__heading body-large ">
                  <span class="richtext-link-inside">Titre de l'article ici</span>
                </h3><p class="multicolumn-card__text richtext-link-inside body-normal">Décrivez brièvement la colonne</p></div></div>
