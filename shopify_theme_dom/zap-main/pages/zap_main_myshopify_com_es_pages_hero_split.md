...
- URL: https://zap-main.myshopify.com/es/pages/hero-split
- Title: Hero split
...
- Headings: Infusión de miel y limón | Caja de luz | Caja de descubrimiento | Infusión de miel y limón | Caja de luz | Caja de descubrimiento | Subscribe to our Newsletter and Get 15% off your first order | Hero split | Sip your way to a healthier day | Sip your way to a healthier day | Sip your way to a healthier day | Sobre nosotros | productos | productos | Servicio al cliente | Servicio al cliente | información | información
...
<div class="section-template--26224001155391__hero_split_KJ6Pmk hero-split hero-split--border-top color-background-1 background section-template--26224001155391__hero_split_KJ6Pmk-padding">
  ...
  <a href="/es/collections" aria-label="Shop Now" class="button button--primary hero-split__button">
