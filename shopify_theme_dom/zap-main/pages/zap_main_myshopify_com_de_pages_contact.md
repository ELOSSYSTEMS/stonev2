...
- URL: https://zap-main.myshopify.com/de/pages/contact
- Title: Kontakt
...
- Headings: Honig-Zitronen-Aufguss | Leuchtkasten | Entdeckerbox | Honig-Zitronen-Aufguss | Leuchtkasten | Entdeckerbox | Subscribe to our Newsletter and Get 15% off your first order | Kontakte | Über uns | Produkte | Produkte | Kundendienst | Kundendienst | Information | Information
...
@media screen and (min-width: 1360px) { #shopify-section-template--25743036743999__contact-form {
  ...
  <div class="container"><div class="contact-form__header contact-form__header--center"><h2 class="contact-form__heading h2">Kontakte</h2><p class="contact-form__description body-normal">Erhalten Sie Benachrichtigungen über neue Updates, Produkte, Tipps und Anleitungen. Kein Spam. Sie können sich jederzeit abmelden.</p></div><div class="contact-form__inner contact-form__inner--center contact-form__inner--first-form content">
      <div class="contact-form__wrapper"><form method="post" action="/de/contact#ContactForm" id="ContactForm" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><div class="field field__name">
            <input class="field__input" autocomplete="name" type="text" dir="ltr" id="ContactForm-template--25743036743999__contact-form-name" name="contact[Name]" value="" placeholder="Name eingeben" style="">
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-name">Name</label>
          </div>
          <div class="field field--with-error">
            <input autocomplete="email" type="email" dir="ltr" id="ContactForm-template--25743036743999__contact-form-email" class="field__input" name="contact[email]" spellcheck="false" autocapitalize="off" value="" aria-required="true" placeholder="E-Mail-Adresse eingeben" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" required="" style="">
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-email">E-Mail</label></div>
          <div class="field">
            <input type="tel" dir="ltr" id="ContactForm-template--25743036743999__contact-form-phone" class="field__input" autocomplete="tel" name="contact[Telefonnummer]" pattern="[0-9\-]*" value="" placeholder="Telefonnummer eingeben" style="">
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-phone">Telefonnummer</label>
          </div>
          <div class="field">
            <textarea id="ContactForm-template--25743036743999__contact-form-body" class="text-area field__input" name="contact[Nachricht]" placeholder="Hier Ihre Nachricht eingeben..." aria-required="true" required="" style=""></textarea>
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-body">Nachricht</label>
          </div><div class="contact-form__bottom">
            <button type="submit" class="button button--primary focus-inset">
              <div class="button__content">
                
                <span class="button__label" data-label="Anfrage einreichen">
                  Anfrage einreichen
                </span>
              </div>
        ...
        <div class="contact-form-info-wrapper color-background-3"><div class="contact-form-info-block contact-form-info-block--left"><h6 class="contact-form-info-block__heading h6">Telefonnummer</h6><div class="contact-form-info-block__description rte body-small">
                    ...
                    <p>Burberry Limited<br> Horseferry House,<br> Horseferry Road,<br> London<br> SW1P 2AW<br> Vereinigtes Königreich</p>
                  </div></div></div>
