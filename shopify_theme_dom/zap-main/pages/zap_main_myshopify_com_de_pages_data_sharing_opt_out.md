...
- URL: https://zap-main.myshopify.com/de/pages/data-sharing-opt-out
...
- Headings: Honig-Zitronen-Aufguss | Leuchtkasten | Entdeckerbox | Honig-Zitronen-Aufguss | Leuchtkasten | Entdeckerbox | Subscribe to our Newsletter and Get 15% off your first order | Ihre Datenschutzeinstellungen | Über uns | Produkte | Produkte | Kundendienst | Kundendienst | Information | Information

## 1. shopify-section-template--25743036809535__main

- Tag: section
- Classes: shopify-section page-section
- Headings: Ihre Datenschutzeinstellungen

```html
<section id="shopify-section-template--25743036809535__main" class="shopify-section page-section"><link href="//zap-main.myshopify.com/cdn/shop/t/2/assets/section-main-page.css?v=165534704276754180541772782652" rel="stylesheet" type="text/css" media="all">
<style data-shopify="">.section-template--25743036809535__main-padding {
...
@media screen and (min-width: 750px) { .section-template--25743036809535__main-padding {
...
@media screen and (min-width: 1360px) { .section-template--25743036809535__main-padding {
...
</style><div class="section-template--25743036809535__main-padding container page-width--narrow">
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="main-page-title page-title title--page h2">Ihre Datenschutzeinstellungen </h1>
    </div>
  </div>
  <div class="rte">
    <link rel="stylesheet" type="text/css" href="https://cdn.shopify.com/shopifycloud/privacy-banner/data-sale-opt-out.css">

<meta charset="utf-8">  <p>Wie in unserer Datenschutzerklärung beschrieben, erfassen wir personenbezogene Daten aus Ihren Interaktionen mit uns und unserer Website, unter anderem mithilfe von Cookies und ähnlichen Technologien. Wir können diese personenbezogenen Daten auch an Dritte, einschließlich Werbepartner, weitergeben. Dies dient dazu, Ihnen auf anderen Websites Werbung anzuzeigen, die besser auf Ihre Interessen zugeschnitten ist, und für weitere in unserer Datenschutzerklärung aufgeführte Zwecke.</p>
<p> Die Weitergabe Ihrer personenbezogenen Daten für zielgerichtete Werbung, basierend auf Ihren Interaktionen auf verschiedenen Websites, kann nach bestimmten Datenschutzgesetzen der US-Bundesstaaten als „Verkauf“, „Weitergabe“ oder „zielgerichtete Werbung“ gelten. Je nach Ihrem Wohnsitz haben Sie möglicherweise das Recht, dieser Nutzung zu widersprechen. Wenn Sie von diesem Widerspruchsrecht Gebrauch machen möchten, folgen Sie bitte den nachstehenden Anweisungen.</p>  <p>Wenn Sie unsere Website mit aktiviertem Opt-out-Signal der Global Privacy Control besuchen, werden wir dies, je nachdem, wo Sie sich befinden, als Anfrage zum Widerspruch gegen Aktivitäten behandeln, die als „Verkauf“ oder „Weitergabe“ personenbezogener Daten oder andere Nutzungen angesehen werden könnten, die als zielgerichtete Werbung für das Gerät und den Browser, mit dem Sie unsere Website besucht haben, angesehen werden könnten. </p>
...
<div id="pc--optOutFormContainer" data-not-applicable="To opt out of the &quot;sale&quot; or &quot;sharing&quot; of your personal information collected using cookies and other device-based identifiers as described above, you must be browsing from one of the applicable US states referred to above." data-description="If you would like to opt out of activity that may be considered a &quot;sale&quot; or &quot;share,&quot; or &quot;targeted advertising&quot;, please submit your email." data-email-label="Email" data-success="Opted-out successfully" data-error="A problem occurred, try submitting your email again" data-form-description="By clicking “opt out“, the browser on this device will be opted out of sharing personal data. If you select the checkbox and enter an email, the related customer account will also be opted out." data-form-email-label="Email" data-form-opt-out-account-label="Don't share data from my account (optional)" data-form-button-text="Opt out" data-form-opted-out="The browser on this device is opted out" data-form-success="You have successfully opted out" data-form-error="A problem occurred, please try again">
  <div id="pc--opt-out-form-container" style="display: none;">
    <p id="optout" class="pc--opt-out-initial">By clicking “opt out“, the browser on this device will be opted out of sharing personal data. If you select the checkbox and enter an email, the related customer account will also be opted out.</p>
    <form action="/dns_opt_out" class="pc--opt-out-form" method="POST" id="pc--opt-out-form" accept-charset="UTF-8">
      <input type="hidden" id="pc_return_to" name="return_to" value="" style="">
      <div class="pc--opt-out-form-container">
        <input type="checkbox" name="opt_out_browser" id="pc--browser-opt-out-checkbox" style="visibility: hidden; position: absolute; left: -9999px;" checked="checked" disabled="true">
      <div class="pc--show-email-field">
        <label for="pc--show-email-field">
          <input type="checkbox" id="pc--show-email-field" style="">
          Don't share data from my account (optional)
        </label>
      </div>
        <div class="pc--opt-out-form-wrapper" id="pc--opt-out-form-field-email" style="display: none;">
          <div class="pc--opt-out-form-field">
            <label for="pc--opt-out-email_input">
              Email
            </label>
            <input id="pc--opt-out-email_input" class="pc--border-color" type="email" name="opt_out_email" value="" autocorrect="off" autocapitalize="off" autocomplete="email" style="">
          </div>
        </div>
        <button type="submit" class="pc--opt-out-form-button pc--border-color" name="pc--commit" id="pc--opt-out-button">
          Opt out
        </button>
        <div id="hcaptcha" class="h-captcha" data-sitekey="b2f59229-c8ff-461c-8062-5d9a4408eb20" data-callback="submitOptOutForm" data-size="invisible"><iframe aria-hidden="true" data-hcaptcha-widget-id="0uq6jim6hxz" data-hcaptcha-response="" src="https://newassets.hcaptcha.com/captcha/v1/9abe19f0c4a8a3dfa7147f989a6f693ecec2228b/static/hcaptcha.html#frame=checkbox-invisible" style="display: none;"></iframe><textarea id="g-recaptcha-response-0uq6jim6hxz" name="g-recaptcha-response" style="display: none;"></textarea><textarea id="h-captcha-response-0uq6jim6hxz" name="h-captcha-response" style="display: none;"></textarea></div>
      </div>
      <p class="pc--opt-out-form-message pc--opt-out-form-message--success" style="display: none;" id="pc--opt-out-success" tabindex="-1" autofocus="">
        ...
        <span>You have successfully opted out</span>
      </p>
      <p class="pc--opt-out-form-message pc--opt-out-form-message--success" style="display: none;" id="pc--opt-out-message" tabindex="-1">
        <svg aria-hidden="true" focusable="false" class="icon icon-success" viewBox="0 0 13 13">
          <path d="M6.5 12.35C9.73087 12.35 12.35 9.73086 12.35 6.5C12.35 3.26913 9.73087 0.65 6.5 0.65C3.26913 0.65 0.65 3.26913 0.65 6.5C0.65 9.73086 3.26913 12.35 6.5 12.35Z" fill="#428445" stroke="white" stroke-width="0.7"></path>
          <path d="M5.53271 8.66357L9.25213 4.68197" stroke="white"></path>
          <path d="M4.10645 6.7688L6.13766 8.62553" stroke="white">
      ...
      <small class="pc--opt-out-form-message form__message" style="display: none;" id="pc--opt-out-error" autofocus="">
  ...
  <p id="pc--opt-out-not-applicable" style="display: block;">
    <strong>To opt out of the "sale" or "sharing" of your personal information collected using cookies and other device-based identifiers as described above, you must be browsing from one of the applicable US states referred to above.</strong>
  </p>
  </div>
...
## 2. shopify-section-template--25743036809535__image-carousel
...
```html
<section id="shopify-section-template--25743036809535__image-carousel" class="shopify-section image-carousel-section spaced-section"><link href="//zap-main.myshopify.com/cdn/shop/t/2/assets/section-image-carousel.css?v=164887749475080061231774520919" rel="stylesheet" type="text/css" media="all">
...
<style data-shopify="">
  #shopify-section-template--25743036809535__image-carousel {
...
@media screen and (min-width: 750px) { #shopify-section-template--25743036809535__image-carousel {
...
@media screen and (min-width: 1360px) { #shopify-section-template--25743036809535__image-carousel {
  ...
  .section-template--25743036809535__image-carousel-padding {
...
@media screen and (min-width: 750px) { .section-template--25743036809535__image-carousel-padding {
...
@media screen and (min-width: 1360px) { .section-template--25743036809535__image-carousel-padding {
...
<style data-shopify="">.section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_1::before {
      content: "";
      display: block;
      width: 0;
    ...
    @media screen and (min-width: 576px) {
      .section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_1::before {
        content: "";
        display: block;
        width: 0;
        padding-bottom: 151.52%;
...
<style data-shopify="">.section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_2::before {
      content: "";
      display: block;
      width: 0;
      padding-bottom: 151.52%;
    ...
    @media screen and (min-width: 576px) {
      .section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_2::before {
        content: "";
        display: block;
        width: 0;
        padding-bottom: 151.52%;
...
<style data-shopify="">.section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_3::before {
      content: "";
      display: block;
      width: 0;
      padding-bottom: 151.52%;
    ...
    @media screen and (min-width: 576px) {
      .section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_3::before {
        content: "";
        display: block;
        width: 0;
        padding-bottom: 151.52%;
...
<style data-shopify="">.section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_4::before {
      content: "";
      display: block;
      width: 0;
      padding-bottom: 151.52%;
    ...
    @media screen and (min-width: 576px) {
      .section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_4::before {
        content: "";
        display: block;
        width: 0;
        padding-bottom: 151.52%;
...
<style data-shopify="">.section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_5::before {
      content: "";
      display: block;
      width: 0;
      padding-bottom: 151.52%;
    ...
    @media screen and (min-width: 576px) {
      .section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_5::before {
        content: "";
        display: block;
        width: 0;
        padding-bottom: 151.52%;
...
<style data-shopify="">.section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_6::before {
      content: "";
      display: block;
      width: 0;
      padding-bottom: 151.52%;
    ...
    @media screen and (min-width: 576px) {
      .section-template--25743036809535__image-carousel-padding .image-carousel__slide-block_6::before {
        content: "";
        display: block;
        width: 0;
        padding-bottom: 151.52%;
...
<div class="image-carousel image-carousel--border-top color-background-1 background section-template--25743036809535__image-carousel-padding"><div class="image-carousel__wrapper content">
...
## 3. shopify-section-template--25743036809535__social-media
...
```html
<section id="shopify-section-template--25743036809535__social-media" class="shopify-section social-media-section spaced-section"><link href="//zap-main.myshopify.com/cdn/shop/t/2/assets/section-social-media.css?v=1000965103519525811772782658" rel="stylesheet" type="text/css" media="all">
<script src="//zap-main.myshopify.com/cdn/shop/t/2/assets/social-media.js?v=178883344589212972821774260016" defer="defer"></script><style data-shopify="">.section-template--25743036809535__social-media-padding {
...
@media screen and (min-width: 750px) { .section-template--25743036809535__social-media-padding {
...
@media screen and (min-width: 1360px) { .section-template--25743036809535__social-media-padding {
  ...
  #shopify-section-template--25743036809535__social-media {
...
@media screen and (min-width: 750px) { #shopify-section-template--25743036809535__social-media {
...
@media screen and (min-width: 1360px) { #shopify-section-template--25743036809535__social-media {
...
<div class="social-media social-media--border-top social-media--border-bottom color-background-1 background section-template--25743036809535__social-media-padding">
