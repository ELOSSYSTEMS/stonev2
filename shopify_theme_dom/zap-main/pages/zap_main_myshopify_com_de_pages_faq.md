...
- URL: https://zap-main.myshopify.com/de/pages/faq
...
- Headings: Honig-Zitronen-Aufguss | Leuchtkasten | Entdeckerbox | Honig-Zitronen-Aufguss | Leuchtkasten | Entdeckerbox | Subscribe to our Newsletter and Get 15% off your first order | Häufig gestellte Fragen | Über uns | Produkte | Produkte | Kundendienst | Kundendienst | Information | Information
...
<div class="collapsible-content color-background-1 background section-template--25743251341631__collapsible_content_LzK6iw-padding" data-enable-header-animation="true" style="--heading-delay: 0s; --description-delay: 0.3s;">
  <div class="container"><div class="collapsible-content__header collapsible-content__header--center"><h2 class="collapsible-content__heading h2"><span class="word" style="--word-index: 0">Häufig</span> <span class="word" style="--word-index: 1">gestellte</span> <span class="word" style="--word-index: 2">Fragen</span></h2></div><div class="collapsible-content__content content collapsible-content__content--center">
      <div class="collapsible-content__items"><div class="collapsible-content__item  active ">
            <button class="collapsible-content__toggle button--unstyled focus-inset">
              <div class="collapsible-content__toggle-group"><p class="collapsible-content__question h4">
                    Wie lange dauert die Bearbeitung einer Bestellung in der Regel?
                  </p></div>
              <div class="collapsible-content__icon"></div>
            </button><div class="collapsible-content__answer body-normal rte">
                <p>Bestellungen werden in der Regel innerhalb von 3 bis 7 Werktagen nach Bestätigung bearbeitet. Sobald Ihre Bestellung verpackt und versandbereit ist, erhalten Sie eine E-Mail mit Ihrer Versandbestätigung und den Sendungsverfolgungsdaten, sodass Sie Ihre Lieferung jederzeit verfolgen können.</p><p> Bitte beachten Sie, dass die Bearbeitungszeiten in Zeiten hohen Bestellaufkommens, an Feiertagen oder bei Produkteinführungen leicht variieren können – wir halten Sie aber stets auf dem Laufenden. Bei Fragen zum Status Ihrer Bestellung steht Ihnen unser Support-Team gerne zur Verfügung.</p>
              </div></div><div class="collapsible-content__item ">
            <button class="collapsible-content__toggle button--unstyled focus-inset">
              <div class="collapsible-content__toggle-group"><p class="collapsible-content__question h4">
                    Kann ich den Inhalt meiner Bestellung ändern?
                  </p></div>
              <div class="collapsible-content__icon"></div>
            </button><div class="collapsible-content__answer body-normal rte" style="display: none;">
                <p>Ja, Änderungen sind möglich, solange die Bestellung noch nicht bearbeitet wird. Bitte aktualisieren Sie Ihre Bestelldaten umgehend nach dem Kauf.</p>
              </div></div><div class="collapsible-content__item ">
            <button class="collapsible-content__toggle button--unstyled focus-inset">
              <div class="collapsible-content__toggle-group"><p class="collapsible-content__question h4">
              ...
              <div class="collapsible-content__icon"></div>
                ...
                <p>Ja, internationaler Versand ist möglich. Lieferzeiten und -kosten variieren je nach Standort und gewählter Versandart.</p>
              </div></div><div class="collapsible-content__item ">
            <button class="collapsible-content__toggle button--unstyled focus-inset">
              <div class="collapsible-content__toggle-group"><p class="collapsible-content__question h4">
                    Sind meine persönlichen Daten während des Bestellvorgangs sicher?
                  </p></div>
              <div class="collapsible-content__icon"></div>
            </button><div class="collapsible-content__answer body-normal rte" style="display: none;">
                <p>Ja, alle Daten werden verschlüsselt und sicher verarbeitet, um Ihre Privatsphäre zu schützen.</p>
              </div></div></div>
    </div>
  </div>
</div>
