...
- URL: https://zap-main.myshopify.com/pages/data-sharing-opt-out
...
- Headings: Honey Lemon Infusion | Light Box | Discovery Box | Honey Lemon Infusion | Light Box | Discovery Box | Subscribe to our Newsletter and Get 15% off your first order | Your Privacy Choices | About us | products | products | Customer service | Customer service | information | information

## 1. shopify-section-template--25743036809535__main

- Tag: section
- Classes: shopify-section page-section
- Headings: Your Privacy Choices
...
@media screen and (min-width: 1360px) { .section-template--25743036809535__main-padding {
  ...
  <div class="page-header">
    <div class="page-header__inner">
      <h1 class="main-page-title page-title title--page h2">Your Privacy Choices</h1>
    </div>
  </div>
  <div class="rte">
  ...
  <div id="pc--opt-out-form-container" style="display: none;">
    ...
    <form action="/dns_opt_out" class="pc--opt-out-form" method="POST" id="pc--opt-out-form" accept-charset="UTF-8">
      ...
      <div class="pc--show-email-field">
        ...
        <div id="hcaptcha" class="h-captcha" data-sitekey="b2f59229-c8ff-461c-8062-5d9a4408eb20" data-callback="submitOptOutForm" data-size="invisible"><iframe aria-hidden="true" data-hcaptcha-widget-id="0kllofoqmxnc" data-hcaptcha-response="" src="https://newassets.hcaptcha.com/captcha/v1/9abe19f0c4a8a3dfa7147f989a6f693ecec2228b/static/hcaptcha.html#frame=checkbox-invisible" style="display: none;"></iframe><textarea id="g-recaptcha-response-0kllofoqmxnc" name="g-recaptcha-response" style="display: none;"></textarea><textarea id="h-captcha-response-0kllofoqmxnc" name="h-captcha-response" style="display: none;"></textarea></div>
      </div>
