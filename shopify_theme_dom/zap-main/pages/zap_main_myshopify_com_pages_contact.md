...
- URL: https://zap-main.myshopify.com/pages/contact
- Title: Contact
...
- Headings: Honey Lemon Infusion | Light Box | Discovery Box | Honey Lemon Infusion | Light Box | Discovery Box | Subscribe to our Newsletter and Get 15% off your first order | contacts | About us | products | products | Customer service | Customer service | information | information
...
@media screen and (min-width: 1360px) { #shopify-section-template--25743036743999__contact-form {
  ...
  <div class="container"><div class="contact-form__header contact-form__header--center"><h2 class="contact-form__heading h2">contacts</h2><p class="contact-form__description body-normal">Get notified about new updates, products, tips and tutorials. No spam. You can always unsubscribe.</p></div><div class="contact-form__inner contact-form__inner--center contact-form__inner--first-form content">
      <div class="contact-form__wrapper"><form method="post" action="/contact#ContactForm" id="ContactForm" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="contact" style=""><input type="hidden" name="utf8" value="✓" style=""><div class="field field__name">
            <input class="field__input" autocomplete="name" type="text" dir="ltr" id="ContactForm-template--25743036743999__contact-form-name" name="contact[Name]" value="" placeholder="Enter your name" style="">
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-name">Name</label>
          </div>
          <div class="field field--with-error">
            <input autocomplete="email" type="email" dir="ltr" id="ContactForm-template--25743036743999__contact-form-email" class="field__input" name="contact[email]" spellcheck="false" autocapitalize="off" value="" aria-required="true" placeholder="Enter your email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" required="" style="">
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-email">Email</label></div>
          <div class="field">
            <input type="tel" dir="ltr" id="ContactForm-template--25743036743999__contact-form-phone" class="field__input" autocomplete="tel" name="contact[Phone number]" pattern="[0-9\-]*" value="" placeholder="Enter your phone number" style="">
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-phone">Phone number</label>
          </div>
          <div class="field">
            <textarea id="ContactForm-template--25743036743999__contact-form-body" class="text-area field__input" name="contact[Message]" placeholder="Type your message here..." aria-required="true" required="" style=""></textarea>
            <label class="field__label body-small" for="ContactForm-template--25743036743999__contact-form-body">Message</label>
