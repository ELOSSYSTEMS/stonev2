...
- URL: https://zap-main.myshopify.com/pages/hero-split
- Title: Hero split
...
- Headings: Honey Lemon Infusion | Light Box | Discovery Box | Honey Lemon Infusion | Light Box | Discovery Box | Subscribe to our Newsletter and Get 15% off your first order | Hero split | Sip your way to a healthier day | Sip your way to a healthier day | Sip your way to a healthier day | About us | products | products | Customer service | Customer service | information | information
...
<div class="section-template--26224001155391__hero_split_KJ6Pmk hero-split hero-split--border-top color-background-1 background section-template--26224001155391__hero_split_KJ6Pmk-padding">
  ...
  <a href="/collections" aria-label="Shop Now" class="button button--primary hero-split__button">
