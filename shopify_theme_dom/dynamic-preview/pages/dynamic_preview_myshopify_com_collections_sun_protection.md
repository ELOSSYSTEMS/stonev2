...
- URL: https://dynamic-preview.myshopify.com/collections/sun-protection
- Title: Sun & Protection – Dynamic
- Body classes: 
...
- Headings: Sun & Protection | Filters | Newsletter | About Dynamic | Shop | Quick links | Customer Care

## 1. shopify-section-template--27935319883942__main-hero

- Tag: div
- Classes: shopify-section
- Headings: Sun & Protection
    ...
    <div class="container">
      <ol class="breadcrumbs__list">
        ...
        <li class="separator" aria-hidden="true">|</li><li class="breadcrumbs__item">
            ...
            <li class="separator" aria-hidden="true">|</li><li class="breadcrumbs__item">
                <a class="breadcrumbs__link" href="/collections/sun-protection" aria-current="page">Sun &amp; Protection</a>
              </li></ol>
    </div>
  </div>
          </div>
              ...
              <div class="product-card-media" data-product-media-slider="" role="region" aria-label="Hydrating Face Serum image gallery">
                ...
                <div class="product_card_image_inner">
                  <div class="product-card-main swiper product-card-swiper swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden">
                    <div class="swiper-wrapper" id="swiper-wrapper-0856501107a72a34" aria-live="polite">
                          ...
                          <div class="swiper-slide product-main-image is-active swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" role="group" aria-hidden="false" aria-label="1 / 3" style="width: 296px; opacity: 1; transform: translate3d(0px, 0px, 0px);">
                            <a class="product_card_link" href="/collections/sun-protection/products/hydrating-face-serum" aria-label="Hydrating Face Serum" tabindex="-1">Hydrating Face Serum</a>
                  ...
                  <button class="product-card-nav product-card-prev swiper-button-disabled" type="button" aria-label="Previous slide" tabindex="-1" disabled="" aria-controls="swiper-wrapper-0856501107a72a34" aria-disabled="true">
...
<path d="M1.44862 8.6999L9.12413 1.0241C9.35843 0.789804 9.35843 0.410004 9.12413 0.175703C8.89013 -0.0585976 8.50972 -0.0585976 8.27572 0.175703L0.175725 8.2757C-0.058575 8.51 -0.058575 8.8898 0.175725 9.1241L8.27572 17.2241C8.39272 17.3414 8.54632 17.3999 8.69993 17.3999C8.85353 17.3999 9.00713 17.3414 9.12413 17.2241C9.35843 16.9898 9.35843 16.61 9.12413 16.3757L1.44862 8.6999Z" fill="#331F17"></path>
                  ...
                  <button class="product-card-nav product-card-next" type="button" aria-label="Next slide" tabindex="0" aria-controls="swiper-wrapper-0856501107a72a34" aria-disabled="false">
    ...
    <div class="product_card_info">
      <div class="product_card__content">
        ...
        <p class="product-card-title">
            ...
            <a href="/collections/sun-protection/products/hydrating-face-serum" title="">Hydrating Face Serum</a>
...
<path d="M12.0572 7.34692H0.878906C0.393398 7.34692 0 6.95353 0 6.46802C0 5.98251 0.393398 5.58911 0.878906 5.58911H12.0572C12.5427 5.58911 12.9361 5.98251 12.9361 6.46802C12.9361 6.95353 12.5427 7.34692 12.0572 7.34692Z" fill="black"></path>
              ...
              <div><ul class=""><li>
                          <label title="In stock" for="collFilter-filter.v.availability-1" class="">
                            <input type="checkbox" name="filter.v.availability" value="1" data-add-url="/collections/sun-protection?filter.v.availability=1" data-remove-url="/collections/sun-protection" id="collFilter-filter.v.availability-1" style="">
                          ...
                          <label title="Out of stock" for="collFilter-filter.v.availability-2" class="">
                            <input type="checkbox" name="filter.v.availability" value="0" data-add-url="/collections/sun-protection?filter.v.availability=0" data-remove-url="/collections/sun-protection" id="collFilter-filter.v.availability-2" disabled="" style="">
...
<path d="M12.0572 7.34692H0.878906C0.393398 7.34692 0 6.95353 0 6.46802C0 5.98251 0.393398 5.58911 0.878906 5.58911H12.0572C12.5427 5.58911 12.9361 5.98251 12.9361 6.46802C12.9361 6.95353 12.5427 7.34692 12.0572 7.34692Z" fill="black"></path>
              ...
              <div><ul class=""><li>
                          <label title="Face Serums" for="collFilter-filter.p.t.category-1" class="">
                            <input type="checkbox" name="filter.p.t.category" value="hb-3-2-9-21" data-add-url="/collections/sun-protection?filter.p.t.category=hb-3-2-9-21" data-remove-url="/collections/sun-protection" id="collFilter-filter.p.t.category-1" style="">
